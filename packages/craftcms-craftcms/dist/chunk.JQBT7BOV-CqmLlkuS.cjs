"use strict";var ts="";function es(t){ts=t}function po(t=""){if(!ts){const e=[...document.getElementsByTagName("script")],i=e.find(s=>s.hasAttribute("data-shoelace"));if(i)es(i.getAttribute("data-shoelace"));else{const s=e.find(a=>/shoelace(\.min)?\.js($|\?)/.test(a.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(a.src));let o="";s&&(o=s.getAttribute("src")),es(o.split("/").slice(0,-1).join("/"))}}return ts.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var Jo={name:"default",resolver:t=>po(`assets/icons/${t}.svg`)},tr=Jo,Is={caret:`
  ...
  `},er={name:"system",resolver:t=>t in Is?`data:image/svg+xml,${encodeURIComponent(Is[t])}`:""},ir=er,ki=[tr,ir],Ci=[];function sr(t){Ci.push(t)}function or(t){Ci=Ci.filter(e=>e!==t)}function Os(t){return ki.find(e=>e.name===t)}function rr(t,e){ar(t),ki.push({name:t,resolver:e.resolver,mutator:e.mutator,spriteSheet:e.spriteSheet}),Ci.forEach(i=>{i.library===t&&i.setIcon()})}function ar(t){ki=ki.filter(e=>e.name!==t)}var fo=Object.defineProperty,nr=Object.defineProperties,lr=Object.getOwnPropertyDescriptor,cr=Object.getOwnPropertyDescriptors,Ls=Object.getOwnPropertySymbols,dr=Object.prototype.hasOwnProperty,hr=Object.prototype.propertyIsEnumerable,Bi=(t,e)=>(e=Symbol[t])?e:Symbol.for("Symbol."+t),ps=t=>{throw TypeError(t)},Ds=(t,e,i)=>e in t?fo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,Qt=(t,e)=>{for(var i in e||(e={}))dr.call(e,i)&&Ds(t,i,e[i]);if(Ls)for(var i of Ls(e))hr.call(e,i)&&Ds(t,i,e[i]);return t},ti=(t,e)=>nr(t,cr(e)),r=(t,e,i,s)=>{for(var o=s>1?void 0:s?lr(e,i):e,a=t.length-1,n;a>=0;a--)(n=t[a])&&(o=(s?n(e,i,o):n(o))||o);return s&&o&&fo(e,i,o),o},mo=(t,e,i)=>e.has(t)||ps("Cannot "+i),ur=(t,e,i)=>(mo(t,e,"read from private field"),e.get(t)),pr=(t,e,i)=>e.has(t)?ps("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),fr=(t,e,i,s)=>(mo(t,e,"write to private field"),e.set(t,i),i),mr=function(t,e){this[0]=t,this[1]=e},br=t=>{var e=t[Bi("asyncIterator")],i=!1,s,o={};return e==null?(e=t[Bi("iterator")](),s=a=>o[a]=n=>e[a](n)):(e=e.call(t),s=a=>o[a]=n=>{if(i){if(i=!1,a==="throw")throw n;return n}return i=!0,{done:!1,value:new mr(new Promise(d=>{var c=e[a](n);c instanceof Object||ps("Object expected"),d(c)}),1)}}),o[Bi("iterator")]=()=>o,s("next"),"throw"in e?s("throw"):o.throw=a=>{throw a},"return"in e&&s("return"),o},De=new WeakMap,Pe=new WeakMap,Me=new WeakMap,Hi=new WeakSet,ui=new WeakMap,Zt=class{constructor(t,e){this.handleFormData=i=>{const s=this.options.disabled(this.host),o=this.options.name(this.host),a=this.options.value(this.host),n=this.host.tagName.toLowerCase()==="sl-button";this.host.isConnected&&!s&&!n&&typeof o=="string"&&o.length>0&&typeof a<"u"&&(Array.isArray(a)?a.forEach(d=>{i.formData.append(o,d.toString())}):i.formData.append(o,a.toString()))},this.handleFormSubmit=i=>{var s;const o=this.options.disabled(this.host),a=this.options.reportValidity;this.form&&!this.form.noValidate&&((s=De.get(this.form))==null||s.forEach(n=>{this.setUserInteracted(n,!0)})),this.form&&!this.form.noValidate&&!o&&!a(this.host)&&(i.preventDefault(),i.stopImmediatePropagation())},this.handleFormReset=()=>{this.options.setValue(this.host,this.options.defaultValue(this.host)),this.setUserInteracted(this.host,!1),ui.set(this.host,[])},this.handleInteraction=i=>{const s=ui.get(this.host);s.includes(i.type)||s.push(i.type),s.length===this.options.assumeInteractionOn.length&&this.setUserInteracted(this.host,!0)},this.checkFormValidity=()=>{if(this.form&&!this.form.noValidate){const i=this.form.querySelectorAll("*");for(const s of i)if(typeof s.checkValidity=="function"&&!s.checkValidity())return!1}return!0},this.reportFormValidity=()=>{if(this.form&&!this.form.noValidate){const i=this.form.querySelectorAll("*");for(const s of i)if(typeof s.reportValidity=="function"&&!s.reportValidity())return!1}return!0},(this.host=t).addController(this),this.options=Qt({form:i=>{const s=i.form;if(s){const a=i.getRootNode().querySelector(`#${s}`);if(a)return a}return i.closest("form")},name:i=>i.name,value:i=>i.value,defaultValue:i=>i.defaultValue,disabled:i=>{var s;return(s=i.disabled)!=null?s:!1},reportValidity:i=>typeof i.reportValidity=="function"?i.reportValidity():!0,checkValidity:i=>typeof i.checkValidity=="function"?i.checkValidity():!0,setValue:(i,s)=>i.value=s,assumeInteractionOn:["sl-input"]},e)}hostConnected(){const t=this.options.form(this.host);t&&this.attachForm(t),ui.set(this.host,[]),this.options.assumeInteractionOn.forEach(e=>{this.host.addEventListener(e,this.handleInteraction)})}hostDisconnected(){this.detachForm(),ui.delete(this.host),this.options.assumeInteractionOn.forEach(t=>{this.host.removeEventListener(t,this.handleInteraction)})}hostUpdated(){const t=this.options.form(this.host);t||this.detachForm(),t&&this.form!==t&&(this.detachForm(),this.attachForm(t)),this.host.hasUpdated&&this.setValidity(this.host.validity.valid)}attachForm(t){t?(this.form=t,De.has(this.form)?De.get(this.form).add(this.host):De.set(this.form,new Set([this.host])),this.form.addEventListener("formdata",this.handleFormData),this.form.addEventListener("submit",this.handleFormSubmit),this.form.addEventListener("reset",this.handleFormReset),Pe.has(this.form)||(Pe.set(this.form,this.form.reportValidity),this.form.reportValidity=()=>this.reportFormValidity()),Me.has(this.form)||(Me.set(this.form,this.form.checkValidity),this.form.checkValidity=()=>this.checkFormValidity())):this.form=void 0}detachForm(){if(!this.form)return;const t=De.get(this.form);t&&(t.delete(this.host),t.size<=0&&(this.form.removeEventListener("formdata",this.handleFormData),this.form.removeEventListener("submit",this.handleFormSubmit),this.form.removeEventListener("reset",this.handleFormReset),Pe.has(this.form)&&(this.form.reportValidity=Pe.get(this.form),Pe.delete(this.form)),Me.has(this.form)&&(this.form.checkValidity=Me.get(this.form),Me.delete(this.form)),this.form=void 0))}setUserInteracted(t,e){e?Hi.add(t):Hi.delete(t),t.requestUpdate()}doAction(t,e){if(this.form){const i=document.createElement("button");i.type=t,i.style.position="absolute",i.style.width="0",i.style.height="0",i.style.clipPath="inset(50%)",i.style.overflow="hidden",i.style.whiteSpace="nowrap",e&&(i.name=e.name,i.value=e.value,["formaction","formenctype","formmethod","formnovalidate","formtarget"].forEach(s=>{e.hasAttribute(s)&&i.setAttribute(s,e.getAttribute(s))})),this.form.append(i),i.click(),i.remove()}}getForm(){var t;return(t=this.form)!=null?t:null}reset(t){this.doAction("reset",t)}submit(t){this.doAction("submit",t)}setValidity(t){const e=this.host,i=!!Hi.has(e),s=!!e.required;e.toggleAttribute("data-required",s),e.toggleAttribute("data-optional",!s),e.toggleAttribute("data-invalid",!t),e.toggleAttribute("data-valid",t),e.toggleAttribute("data-user-invalid",!t&&i),e.toggleAttribute("data-user-valid",t&&i)}updateValidity(){const t=this.host;this.setValidity(t.validity.valid)}emitInvalidEvent(t){const e=new CustomEvent("sl-invalid",{bubbles:!1,composed:!1,cancelable:!0,detail:{}});t||e.preventDefault(),this.host.dispatchEvent(e)||t==null||t.preventDefault()}},Oi=Object.freeze({badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valid:!0,valueMissing:!1}),gr=Object.freeze(ti(Qt({},Oi),{valid:!1,valueMissing:!0})),vr=Object.freeze(ti(Qt({},Oi),{valid:!1,customError:!0}));/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yi=globalThis,fs=yi.ShadowRoot&&(yi.ShadyCSS===void 0||yi.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ms=Symbol(),Ps=new WeakMap;let bo=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==ms)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(fs&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=Ps.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Ps.set(i,e))}return e}toString(){return this.cssText}};const yr=t=>new bo(typeof t=="string"?t:t+"",void 0,ms),T=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,o,a)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+t[a+1],t[0]);return new bo(i,t,ms)},_r=(t,e)=>{if(fs)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),o=yi.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=i.cssText,t.appendChild(s)}},Ms=fs?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return yr(i)})(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:wr,defineProperty:xr,getOwnPropertyDescriptor:kr,getOwnPropertyNames:Cr,getOwnPropertySymbols:$r,getPrototypeOf:Sr}=Object,ee=globalThis,Rs=ee.trustedTypes,zr=Rs?Rs.emptyScript:"",Ni=ee.reactiveElementPolyfillSupport,He=(t,e)=>t,Ce={toAttribute(t,e){switch(e){case Boolean:t=t?zr:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},bs=(t,e)=>!wr(t,e),Fs={attribute:!0,type:String,converter:Ce,reflect:!1,useDefault:!1,hasChanged:bs};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ee.litPropertyMetadata??(ee.litPropertyMetadata=new WeakMap);let we=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Fs){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(e,s,i);o!==void 0&&xr(this.prototype,e,o)}}static getPropertyDescriptor(e,i,s){const{get:o,set:a}=kr(this.prototype,e)??{get(){return this[i]},set(n){this[i]=n}};return{get:o,set(n){const d=o==null?void 0:o.call(this);a==null||a.call(this,n),this.requestUpdate(e,d,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Fs}static _$Ei(){if(this.hasOwnProperty(He("elementProperties")))return;const e=Sr(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(He("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(He("properties"))){const i=this.properties,s=[...Cr(i),...$r(i)];for(const o of s)this.createProperty(o,i[o])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,o]of i)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const o=this._$Eu(i,s);o!==void 0&&this._$Eh.set(o,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const o of s)i.unshift(Ms(o))}else e!==void 0&&i.push(Ms(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(i=>i(this))}addController(e){var i;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)==null||i.call(e))}removeController(e){var i;(i=this._$EO)==null||i.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return _r(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostConnected)==null?void 0:s.call(i)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostDisconnected)==null?void 0:s.call(i)})}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){var a;const s=this.constructor.elementProperties.get(e),o=this.constructor._$Eu(e,s);if(o!==void 0&&s.reflect===!0){const n=(((a=s.converter)==null?void 0:a.toAttribute)!==void 0?s.converter:Ce).toAttribute(i,s.type);this._$Em=e,n==null?this.removeAttribute(o):this.setAttribute(o,n),this._$Em=null}}_$AK(e,i){var a,n;const s=this.constructor,o=s._$Eh.get(e);if(o!==void 0&&this._$Em!==o){const d=s.getPropertyOptions(o),c=typeof d.converter=="function"?{fromAttribute:d.converter}:((a=d.converter)==null?void 0:a.fromAttribute)!==void 0?d.converter:Ce;this._$Em=o,this[o]=c.fromAttribute(i,d.type)??((n=this._$Ej)==null?void 0:n.get(o))??null,this._$Em=null}}requestUpdate(e,i,s){var o;if(e!==void 0){const a=this.constructor,n=this[e];if(s??(s=a.getPropertyOptions(e)),!((s.hasChanged??bs)(n,i)||s.useDefault&&s.reflect&&n===((o=this._$Ej)==null?void 0:o.get(e))&&!this.hasAttribute(a._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:o,wrapped:a},n){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,n??i??this[e]),a!==!0||n!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),o===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[a,n]of o){const{wrapped:d}=n,c=this[a];d!==!0||this._$AL.has(a)||c===void 0||this.C(a,void 0,n,c)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(s=this._$EO)==null||s.forEach(o=>{var a;return(a=o.hostUpdate)==null?void 0:a.call(o)}),this.update(i)):this._$EM()}catch(o){throw e=!1,this._$EM(),o}e&&this._$AE(i)}willUpdate(e){}_$AE(e){var i;(i=this._$EO)==null||i.forEach(s=>{var o;return(o=s.hostUpdated)==null?void 0:o.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(e){}firstUpdated(e){}};we.elementStyles=[],we.shadowRootOptions={mode:"open"},we[He("elementProperties")]=new Map,we[He("finalized")]=new Map,Ni==null||Ni({ReactiveElement:we}),(ee.reactiveElementVersions??(ee.reactiveElementVersions=[])).push("2.1.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ne=globalThis,$i=Ne.trustedTypes,Vs=$i?$i.createPolicy("lit-html",{createHTML:t=>t}):void 0,go="$lit$",Jt=`lit$${Math.random().toFixed(9).slice(2)}$`,vo="?"+Jt,Ar=`<${vo}>`,pe=document,Ge=()=>pe.createComment(""),Qe=t=>t===null||typeof t!="object"&&typeof t!="function",gs=Array.isArray,Er=t=>gs(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",Ui=`[ 	
\f\r]`,Re=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Bs=/-->/g,Hs=/>/g,ne=RegExp(`>|${Ui}(?:([^\\s"'>=/]+)(${Ui}*=${Ui}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ns=/'/g,Us=/"/g,yo=/^(?:script|style|textarea|title)$/i,Tr=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),y=Tr(1),Ct=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),Ws=new WeakMap,de=pe.createTreeWalker(pe,129);function _o(t,e){if(!gs(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Vs!==void 0?Vs.createHTML(e):e}const Ir=(t,e)=>{const i=t.length-1,s=[];let o,a=e===2?"<svg>":e===3?"<math>":"",n=Re;for(let d=0;d<i;d++){const c=t[d];let h,f,u=-1,p=0;for(;p<c.length&&(n.lastIndex=p,f=n.exec(c),f!==null);)p=n.lastIndex,n===Re?f[1]==="!--"?n=Bs:f[1]!==void 0?n=Hs:f[2]!==void 0?(yo.test(f[2])&&(o=RegExp("</"+f[2],"g")),n=ne):f[3]!==void 0&&(n=ne):n===ne?f[0]===">"?(n=o??Re,u=-1):f[1]===void 0?u=-2:(u=n.lastIndex-f[2].length,h=f[1],n=f[3]===void 0?ne:f[3]==='"'?Us:Ns):n===Us||n===Ns?n=ne:n===Bs||n===Hs?n=Re:(n=ne,o=void 0);const m=n===ne&&t[d+1].startsWith("/>")?" ":"";a+=n===Re?c+Ar:u>=0?(s.push(h),c.slice(0,u)+go+c.slice(u)+Jt+m):c+Jt+(u===-2?d:m)}return[_o(t,a+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class Ze{constructor({strings:e,_$litType$:i},s){let o;this.parts=[];let a=0,n=0;const d=e.length-1,c=this.parts,[h,f]=Ir(e,i);if(this.el=Ze.createElement(h,s),de.currentNode=this.el.content,i===2||i===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(o=de.nextNode())!==null&&c.length<d;){if(o.nodeType===1){if(o.hasAttributes())for(const u of o.getAttributeNames())if(u.endsWith(go)){const p=f[n++],m=o.getAttribute(u).split(Jt),b=/([.?@])?(.*)/.exec(p);c.push({type:1,index:a,name:b[2],strings:m,ctor:b[1]==="."?Lr:b[1]==="?"?Dr:b[1]==="@"?Pr:Li}),o.removeAttribute(u)}else u.startsWith(Jt)&&(c.push({type:6,index:a}),o.removeAttribute(u));if(yo.test(o.tagName)){const u=o.textContent.split(Jt),p=u.length-1;if(p>0){o.textContent=$i?$i.emptyScript:"";for(let m=0;m<p;m++)o.append(u[m],Ge()),de.nextNode(),c.push({type:2,index:++a});o.append(u[p],Ge())}}}else if(o.nodeType===8)if(o.data===vo)c.push({type:2,index:a});else{let u=-1;for(;(u=o.data.indexOf(Jt,u+1))!==-1;)c.push({type:7,index:a}),u+=Jt.length-1}a++}}static createElement(e,i){const s=pe.createElement("template");return s.innerHTML=e,s}}function $e(t,e,i=t,s){var n,d;if(e===Ct)return e;let o=s!==void 0?(n=i._$Co)==null?void 0:n[s]:i._$Cl;const a=Qe(e)?void 0:e._$litDirective$;return(o==null?void 0:o.constructor)!==a&&((d=o==null?void 0:o._$AO)==null||d.call(o,!1),a===void 0?o=void 0:(o=new a(t),o._$AT(t,i,s)),s!==void 0?(i._$Co??(i._$Co=[]))[s]=o:i._$Cl=o),o!==void 0&&(e=$e(t,o._$AS(t,e.values),o,s)),e}class Or{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,o=((e==null?void 0:e.creationScope)??pe).importNode(i,!0);de.currentNode=o;let a=de.nextNode(),n=0,d=0,c=s[0];for(;c!==void 0;){if(n===c.index){let h;c.type===2?h=new ei(a,a.nextSibling,this,e):c.type===1?h=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(h=new Mr(a,this,e)),this._$AV.push(h),c=s[++d]}n!==(c==null?void 0:c.index)&&(a=de.nextNode(),n++)}return de.currentNode=pe,o}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class ei{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,s,o){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=$e(this,e,i),Qe(e)?e===K||e==null||e===""?(this._$AH!==K&&this._$AR(),this._$AH=K):e!==this._$AH&&e!==Ct&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Er(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==K&&Qe(this._$AH)?this._$AA.nextSibling.data=e:this.T(pe.createTextNode(e)),this._$AH=e}$(e){var a;const{values:i,_$litType$:s}=e,o=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Ze.createElement(_o(s.h,s.h[0]),this.options)),s);if(((a=this._$AH)==null?void 0:a._$AD)===o)this._$AH.p(i);else{const n=new Or(o,this),d=n.u(this.options);n.p(i),this.T(d),this._$AH=n}}_$AC(e){let i=Ws.get(e.strings);return i===void 0&&Ws.set(e.strings,i=new Ze(e)),i}k(e){gs(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,o=0;for(const a of e)o===i.length?i.push(s=new ei(this.O(Ge()),this.O(Ge()),this,this.options)):s=i[o],s._$AI(a),o++;o<i.length&&(this._$AR(s&&s._$AB.nextSibling,o),i.length=o)}_$AR(e=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class Li{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,o,a){this.type=1,this._$AH=K,this._$AN=void 0,this.element=e,this.name=i,this._$AM=o,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=K}_$AI(e,i=this,s,o){const a=this.strings;let n=!1;if(a===void 0)e=$e(this,e,i,0),n=!Qe(e)||e!==this._$AH&&e!==Ct,n&&(this._$AH=e);else{const d=e;let c,h;for(e=a[0],c=0;c<a.length-1;c++)h=$e(this,d[s+c],i,c),h===Ct&&(h=this._$AH[c]),n||(n=!Qe(h)||h!==this._$AH[c]),h===K?e=K:e!==K&&(e+=(h??"")+a[c+1]),this._$AH[c]=h}n&&!o&&this.j(e)}j(e){e===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let Lr=class extends Li{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===K?void 0:e}};class Dr extends Li{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==K)}}class Pr extends Li{constructor(e,i,s,o,a){super(e,i,s,o,a),this.type=5}_$AI(e,i=this){if((e=$e(this,e,i,0)??K)===Ct)return;const s=this._$AH,o=e===K&&s!==K||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,a=e!==K&&(s===K||o);o&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class Mr{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){$e(this,e)}}const Wi=Ne.litHtmlPolyfillSupport;Wi==null||Wi(Ze,ei),(Ne.litHtmlVersions??(Ne.litHtmlVersions=[])).push("3.3.0");const Rr=(t,e,i)=>{const s=(i==null?void 0:i.renderBefore)??e;let o=s._$litPart$;if(o===void 0){const a=(i==null?void 0:i.renderBefore)??null;s._$litPart$=o=new ei(e.insertBefore(Ge(),a),a,void 0,i??{})}return o._$AI(t),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ue=globalThis;let Ue=class extends we{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Rr(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Ct}};var uo;Ue._$litElement$=!0,Ue.finalized=!0,(uo=ue.litElementHydrateSupport)==null||uo.call(ue,{LitElement:Ue});const qi=ue.litElementPolyfillSupport;qi==null||qi({LitElement:Ue});(ue.litElementVersions??(ue.litElementVersions=[])).push("4.2.0");var Fr=T`
  :host {
    display: block;
    outline: 0;
    z-index: 0;
...
`,ze=(t="value")=>(e,i)=>{const s=e.constructor,o=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(a,n,d){var c;const h=s.getPropertyOptions(t),f=typeof h.attribute=="string"?h.attribute:t;if(a===f){const u=h.converter||Ce,m=(typeof u=="function"?u:(c=u==null?void 0:u.fromAttribute)!=null?c:Ce.fromAttribute)(d,h.type);this[t]!==m&&(this[i]=m)}o.call(this,a,n,d)}},be=T`
...
`,vt=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=i=>{const s=i.target;(this.slotNames.includes("[default]")&&!s.name||s.name&&this.slotNames.includes(s.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){const e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function Br(t){if(!t)return"";const e=t.assignedNodes({flatten:!0});let i="";return[...e].forEach(s=>{s.nodeType===Node.TEXT_NODE&&(i+=s.textContent)}),i}var Hr=T`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nr={attribute:!0,type:String,converter:Ce,reflect:!1,hasChanged:bs},Ur=(t=Nr,e,i)=>{const{kind:s,metadata:o}=i;let a=globalThis.litPropertyMetadata.get(o);if(a===void 0&&globalThis.litPropertyMetadata.set(o,a=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),a.set(i.name,t),s==="accessor"){const{name:n}=i;return{set(d){const c=e.get.call(this);e.set.call(this,d),this.requestUpdate(n,c,t)},init(d){return d!==void 0&&this.C(n,void 0,t,d),d}}}if(s==="setter"){const{name:n}=i;return function(d){const c=this[n];e.call(this,d),this.requestUpdate(n,c,t)}}throw Error("Unsupported decorator location: "+s)};function l(t){return(e,i)=>typeof i=="object"?Ur(t,e,i):((s,o,a)=>{const n=o.hasOwnProperty(a);return o.constructor.createProperty(a,s),n?Object.getOwnPropertyDescriptor(o,a):void 0})(t,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Wr(t){return(e,i)=>wo(e,i,{async get(){var s;return await this.updateComplete,((s=this.renderRoot)==null?void 0:s.querySelector(t))??null}})}var _i,z=class extends Ue{constructor(){super(),pr(this,_i,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([t,e])=>{this.constructor.define(t,e)})}emit(t,e){const i=new CustomEvent(t,Qt({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(i),i}static define(t,e=this,i={}){const s=customElements.get(t);if(!s){try{customElements.define(t,e,i)}catch{customElements.define(t,class extends e{},i)}return}let o=" (unknown version)",a=o;"version"in e&&e.version&&(o=" v"+e.version),"version"in s&&s.version&&(a=" v"+s.version),!(o&&a&&o===a)&&console.warn(`Attempted to register <${t}>${o}, but <${t}>${a} has already been registered.`)}attributeChangedCallback(t,e,i){ur(this,_i)||(this.constructor.elementProperties.forEach((s,o)=>{s.reflect&&this[o]!=null&&this.initialReflectedProperties.set(o,this[o])}),fr(this,_i,!0)),super.attributeChangedCallback(t,e,i)}willUpdate(t){super.willUpdate(t),this.initialReflectedProperties.forEach((e,i)=>{t.has(i)&&this[i]==null&&(this[i]=e)})}};_i=new WeakMap;z.version="2.20.1";z.dependencies={};r([l()],z.prototype,"dir",2);r([l()],z.prototype,"lang",2);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qr=(t,e)=>(t==null?void 0:t._$litType$)!==void 0,xo=t=>t.strings===void 0,jr={},Kr=(t,e=jr)=>t._$AH=e;var Fe=Symbol(),pi=Symbol(),ji,Ki=new Map,j=class extends z{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var i;let s;if(e!=null&&e.spriteSheet)return this.svg=y`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,this.svg;try{if(s=await fetch(t,{mode:"cors"}),!s.ok)return s.status===410?Fe:pi}catch{return pi}try{const o=document.createElement("div");o.innerHTML=await s.text();const a=o.firstElementChild;if(((i=a==null?void 0:a.tagName)==null?void 0:i.toLowerCase())!=="svg")return Fe;ji||(ji=new DOMParser);const d=ji.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return d?(d.part.add("svg"),document.adoptNode(d)):Fe}catch{return Fe}}connectedCallback(){super.connectedCallback(),sr(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),or(this)}getIconSource(){const t=Os(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const{url:e,fromLibrary:i}=this.getIconSource(),s=i?Os(this.library):void 0;if(!e){this.svg=null;return}let o=Ki.get(e);if(o||(o=this.resolveIcon(e,s),Ki.set(e,o)),!this.initialRender)return;const a=await o;if(a===pi&&Ki.delete(e),e===this.getIconSource().url){if(qr(a)){if(this.svg=a,s){await this.updateComplete;const n=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&n&&s.mutator(n)}return}switch(a){case pi:case Fe:this.svg=null,this.emit("sl-error");break;default:this.svg=a.cloneNode(!0),(t=s==null?void 0:s.mutator)==null||t.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};j.styles=[L,Hr];r([I()],j.prototype,"svg",2);r([l({reflect:!0})],j.prototype,"name",2);r([l()],j.prototype,"src",2);r([l()],j.prototype,"label",2);r([l({reflect:!0})],j.prototype,"library",2);r([x("label")],j.prototype,"handleLabelChange",1);r([x(["name","src","library"])],j.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},si=t=>(...e)=>({_$litDirective$:t,values:e});let oi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,i,s){this._$Ct=e,this._$AM=i,this._$Ci=s}_$AS(e,i){return this.update(e,i)}update(e,i){return this.render(...i)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const O=si(class extends oi{constructor(t){var e;if(super(t),t.type!==Nt.ATTRIBUTE||t.name!=="class"||((e=t.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){var s,o;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!((s=this.nt)!=null&&s.has(a))&&this.st.add(a);return this.render(e)}const i=t.element.classList;for(const a of this.st)a in e||(i.remove(a),this.st.delete(a));for(const a in e){const n=!!e[a];n===this.st.has(a)||(o=this.nt)!=null&&o.has(a)||(n?(i.add(a),this.st.add(a)):(i.remove(a),this.st.delete(a)))}return Ct}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const S=t=>t??K;/**
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=si(class extends oi{constructor(t){if(super(t),t.type!==Nt.PROPERTY&&t.type!==Nt.ATTRIBUTE&&t.type!==Nt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!xo(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===Ct||e===K)return e;const i=t.element,s=t.name;if(t.type===Nt.PROPERTY){if(e===i[s])return Ct}else if(t.type===Nt.BOOLEAN_ATTRIBUTE){if(!!e===i.hasAttribute(s))return Ct}else if(t.type===Nt.ATTRIBUTE&&i.getAttribute(s)===e+"")return Ct;return Kr(t),e}});var st=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new vt(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return y`
      <div
    ...
    `}};st.styles=[L,be,Vr];st.dependencies={"sl-icon":j};r([k('input[type="checkbox"]')],st.prototype,"input",2);r([I()],st.prototype,"hasFocus",2);r([l()],st.prototype,"title",2);r([l()],st.prototype,"name",2);r([l()],st.prototype,"value",2);r([l({reflect:!0})],st.prototype,"size",2);r([l({type:Boolean,reflect:!0})],st.prototype,"disabled",2);r([l({type:Boolean,reflect:!0})],st.prototype,"checked",2);r([l({type:Boolean,reflect:!0})],st.prototype,"indeterminate",2);r([ze("checked")],st.prototype,"defaultChecked",2);r([l({reflect:!0})],st.prototype,"form",2);r([l({type:Boolean,reflect:!0})],st.prototype,"required",2);r([l({attribute:"help-text"})],st.prototype,"helpText",2);r([x("disabled",{waitUntilFirstUpdate:!0})],st.prototype,"handleDisabledChange",1);r([x(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],st.prototype,"handleStateChange",1);var Xr=T`
  :host {
    --track-width: 2px;
...
`;const is=new Set,xe=new Map;let ce,vs="ltr",ys="en";const ko=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(ko){const t=new MutationObserver($o);vs=document.documentElement.dir||"ltr",ys=document.documentElement.lang||navigator.language,t.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Co(...t){t.map(e=>{const i=e.$code.toLowerCase();xe.has(i)?xe.set(i,Object.assign(Object.assign({},xe.get(i)),e)):xe.set(i,e),ce||(ce=e)}),$o()}function $o(){ko&&(vs=document.documentElement.dir||"ltr",ys=document.documentElement.lang||navigator.language),[...is.keys()].map(t=>{typeof t.requestUpdate=="function"&&t.requestUpdate()})}let Yr=class{constructor(e){this.host=e,this.host.addController(this)}hostConnected(){is.add(this.host)}hostDisconnected(){is.delete(this.host)}dir(){return`${this.host.dir||vs}`.toLowerCase()}lang(){return`${this.host.lang||ys}`.toLowerCase()}getTranslationData(e){var i,s;const o=new Intl.Locale(e.replace(/_/g,"-")),a=o==null?void 0:o.language.toLowerCase(),n=(s=(i=o==null?void 0:o.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&s!==void 0?s:"",d=xe.get(`${a}-${n}`),c=xe.get(a);return{locale:o,language:a,region:n,primary:d,secondary:c}}exists(e,i){var s;const{primary:o,secondary:a}=this.getTranslationData((s=i.lang)!==null&&s!==void 0?s:this.lang());return i=Object.assign({includeFallback:!1},i),!!(o&&o[e]||a&&a[e]||i.includeFallback&&ce&&ce[e])}term(e,...i){const{primary:s,secondary:o}=this.getTranslationData(this.lang());let a;if(s&&s[e])a=s[e];else if(o&&o[e])a=o[e];else if(ce&&ce[e])a=ce[e];else return console.error(`No translation found for: ${String(e)}`),String(e);return typeof a=="function"?a(...i):a}date(e,i){return e=new Date(e),new Intl.DateTimeFormat(this.lang(),i).format(e)}number(e,i){return e=Number(e),isNaN(e)?"":new Intl.NumberFormat(this.lang(),i).format(e)}relativeTime(e,i,s){return new Intl.RelativeTimeFormat(this.lang(),s).format(e,i)}};var So={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(t,e)=>`Go to slide ${t} of ${e}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:t=>t===0?"No options selected":t===1?"1 option selected":`${t} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:t=>`Slide ${t}`,toggleColorFormat:"Toggle color format"};Co(So);var Gr=So,H=class extends Yr{};Co(Gr);var ri=class extends z{constructor(){super(...arguments),this.localize=new H(this)}render(){return y`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};ri.styles=[L,Xr];var zo=new Map,Qr=new WeakMap;function Zr(t){return t??{keyframes:[],options:{duration:0}}}function qs(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function U(t,e){zo.set(t,Zr(e))}function X(t,e,i){const s=Qr.get(t);if(s!=null&&s[e])return qs(s[e],i.dir);const o=zo.get(e);return o?qs(o,i.dir):{keyframes:[],options:{duration:0}}}function Z(t,e,i){return new Promise(s=>{if((i==null?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const o=t.animate(e,ti(Qt({},i),{duration:ss()?0:i.duration}));o.addEventListener("cancel",s,{once:!0}),o.addEventListener("finish",s,{once:!0})})}function js(t){return t=t.toString().toLowerCase(),t.indexOf("ms")>-1?parseFloat(t):t.indexOf("s")>-1?parseFloat(t)*1e3:parseFloat(t)}function ss(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function it(t){return Promise.all(t.getAnimations().map(e=>new Promise(i=>{e.cancel(),requestAnimationFrame(i)})))}function Si(t,e){return t.map(i=>ti(Qt({},i),{height:i.height==="auto"?`${e}px`:i.height}))}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ks(t,e,i){return t?e(t):i==null?void 0:i(t)}var J=class os extends z{constructor(){super(...arguments),this.localize=new H(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}static isTreeItem(e){return e instanceof Element&&e.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange()}async animateCollapse(){this.emit("sl-collapse"),await it(this.childrenContainer);const{keyframes:e,options:i}=X(this,"tree-item.collapse",{dir:this.localize.dir()});await Z(this.childrenContainer,Si(e,this.childrenContainer.scrollHeight),i),this.childrenContainer.hidden=!0,this.emit("sl-after-collapse")}isNestedItem(){const e=this.parentElement;return!!e&&os.isTreeItem(e)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0}willUpdate(e){e.has("selected")&&!e.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(){this.emit("sl-expand"),await it(this.childrenContainer),this.childrenContainer.hidden=!1;const{keyframes:e,options:i}=X(this,"tree-item.expand",{dir:this.localize.dir()});await Z(this.childrenContainer,Si(e,this.childrenContainer.scrollHeight),i),this.childrenContainer.style.height="auto",this.emit("sl-after-expand")}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse()}handleLazyChange(){this.emit("sl-lazy-change")}getChildrenItems({includeDisabled:e=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(i=>os.isTreeItem(i)&&(e||!i.disabled)):[]}render(){const e=this.localize.dir()==="rtl",i=!this.loading&&(!this.isLeaf||this.lazy);return y`
      <div
        part="base"
      ...
      >
        ...
        >
          ...
          <div
            ...
            aria-hidden="true"
          >
            ${Ks(this.loading,()=>y` <sl-spinner part="spinner" exportparts="base:spinner__base"></sl-spinner> `)}
...
`;const ie=Math.min,kt=Math.max,zi=Math.round,fi=Math.floor,Ut=t=>({x:t,y:t}),ea={left:"right",right:"left",bottom:"top",top:"bottom"},ia={start:"end",end:"start"};function rs(t,e,i){return kt(t,ie(e,i))}function Ae(t,e){return typeof t=="function"?t(e):t}function se(t){return t.split("-")[0]}function Ee(t){return t.split("-")[1]}function Ao(t){return t==="x"?"y":"x"}function _s(t){return t==="y"?"height":"width"}function ai(t){return["top","bottom"].includes(se(t))?"y":"x"}function ws(t){return Ao(ai(t))}function sa(t,e,i){i===void 0&&(i=!1);const s=Ee(t),o=ws(t),a=_s(o);let n=o==="x"?s===(i?"end":"start")?"right":"left":s==="start"?"bottom":"top";return e.reference[a]>e.floating[a]&&(n=Ai(n)),[n,Ai(n)]}function oa(t){const e=Ai(t);return[as(t),e,as(e)]}function as(t){return t.replace(/start|end/g,e=>ia[e])}function ra(t,e,i){const s=["left","right"],o=["right","left"],a=["top","bottom"],n=["bottom","top"];switch(t){case"top":case"bottom":return i?e?o:s:e?s:o;case"left":case"right":return e?a:n;default:return[]}}function aa(t,e,i,s){const o=Ee(t);let a=ra(se(t),i==="start",s);return o&&(a=a.map(n=>n+"-"+o),e&&(a=a.concat(a.map(as)))),a}function Ai(t){return t.replace(/left|right|bottom|top/g,e=>ea[e])}function na(t){return{top:0,right:0,bottom:0,left:0,...t}}function Eo(t){return typeof t!="number"?na(t):{top:t,right:t,bottom:t,left:t}}function Ei(t){const{x:e,y:i,width:s,height:o}=t;return{width:s,height:o,top:i,left:e,right:e+s,bottom:i+o,x:e,y:i}}function Xs(t,e,i){let{reference:s,floating:o}=t;const a=ai(e),n=ws(e),d=_s(n),c=se(e),h=a==="y",f=s.x+s.width/2-o.width/2,u=s.y+s.height/2-o.height/2,p=s[d]/2-o[d]/2;let m;switch(c){case"top":m={x:f,y:s.y-o.height};break;case"bottom":m={x:f,y:s.y+s.height};break;case"right":m={x:s.x+s.width,y:u};break;case"left":m={x:s.x-o.width,y:u};break;default:m={x:s.x,y:s.y}}switch(Ee(e)){case"start":m[n]-=p*(i&&h?-1:1);break;case"end":m[n]+=p*(i&&h?-1:1);break}return m}const la=async(t,e,i)=>{const{placement:s="bottom",strategy:o="absolute",middleware:a=[],platform:n}=i,d=a.filter(Boolean),c=await(n.isRTL==null?void 0:n.isRTL(e));let h=await n.getElementRects({reference:t,floating:e,strategy:o}),{x:f,y:u}=Xs(h,s,c),p=s,m={},b=0;for(let v=0;v<d.length;v++){const{name:$,fn:E}=d[v],{x:w,y:C,data:g,reset:_}=await E({x:f,y:u,initialPlacement:s,placement:p,strategy:o,middlewareData:m,rects:h,platform:n,elements:{reference:t,floating:e}});f=w??f,u=C??u,m={...m,[$]:{...m[$],...g}},_&&b<=50&&(b++,typeof _=="object"&&(_.placement&&(p=_.placement),_.rects&&(h=_.rects===!0?await n.getElementRects({reference:t,floating:e,strategy:o}):_.rects),{x:f,y:u}=Xs(h,p,c)),v=-1)}return{x:f,y:u,placement:p,strategy:o,middlewareData:m}};async function xs(t,e){var i;e===void 0&&(e={});const{x:s,y:o,platform:a,rects:n,elements:d,strategy:c}=t,{boundary:h="clippingAncestors",rootBoundary:f="viewport",elementContext:u="floating",altBoundary:p=!1,padding:m=0}=Ae(e,t),b=Eo(m),$=d[p?u==="floating"?"reference":"floating":u],E=Ei(await a.getClippingRect({element:(i=await(a.isElement==null?void 0:a.isElement($)))==null||i?$:$.contextElement||await(a.getDocumentElement==null?void 0:a.getDocumentElement(d.floating)),boundary:h,rootBoundary:f,strategy:c})),w=u==="floating"?{...n.floating,x:s,y:o}:n.reference,C=await(a.getOffsetParent==null?void 0:a.getOffsetParent(d.floating)),g=await(a.isElement==null?void 0:a.isElement(C))?await(a.getScale==null?void 0:a.getScale(C))||{x:1,y:1}:{x:1,y:1},_=Ei(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:d,rect:w,offsetParent:C,strategy:c}):w);return{top:(E.top-_.top+b.top)/g.y,bottom:(_.bottom-E.bottom+b.bottom)/g.y,left:(E.left-_.left+b.left)/g.x,right:(_.right-E.right+b.right)/g.x}}const ca=t=>({name:"arrow",options:t,async fn(e){const{x:i,y:s,placement:o,rects:a,platform:n,elements:d,middlewareData:c}=e,{element:h,padding:f=0}=Ae(t,e)||{};if(h==null)return{};const u=Eo(f),p={x:i,y:s},m=ws(o),b=_s(m),v=await n.getDimensions(h),$=m==="y",E=$?"top":"left",w=$?"bottom":"right",C=$?"clientHeight":"clientWidth",g=a.reference[b]+a.reference[m]-p[m]-a.floating[b],_=p[m]-a.reference[m],A=await(n.getOffsetParent==null?void 0:n.getOffsetParent(h));let M=A?A[C]:0;(!M||!await(n.isElement==null?void 0:n.isElement(A)))&&(M=d.floating[C]||a.floating[b]);const F=g/2-_/2,P=M/2-v[b]/2-1,D=ie(u[E],P),pt=ie(u[w],P),G=D,_t=M-v[b]-pt,rt=M/2-v[b]/2+F,bt=rs(G,rt,_t),Lt=!c.arrow&&Ee(o)!=null&&rt!==bt&&a.reference[b]/2-(rt<G?D:pt)-v[b]/2<0,Gt=Lt?rt<G?rt-G:rt-_t:0;return{[m]:p[m]+Gt,data:{[m]:bt,centerOffset:rt-bt-Gt,...Lt&&{alignmentOffset:Gt}},reset:Lt}}}),da=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(e){var i,s;const{placement:o,middlewareData:a,rects:n,initialPlacement:d,platform:c,elements:h}=e,{mainAxis:f=!0,crossAxis:u=!0,fallbackPlacements:p,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:v=!0,...$}=Ae(t,e);if((i=a.arrow)!=null&&i.alignmentOffset)return{};const E=se(o),w=se(d)===d,C=await(c.isRTL==null?void 0:c.isRTL(h.floating)),g=p||(w||!v?[Ai(d)]:oa(d));!p&&b!=="none"&&g.push(...aa(d,v,b,C));const _=[d,...g],A=await xs(e,$),M=[];let F=((s=a.flip)==null?void 0:s.overflows)||[];if(f&&M.push(A[E]),u){const G=sa(o,n,C);M.push(A[G[0]],A[G[1]])}if(F=[...F,{placement:o,overflows:M}],!M.every(G=>G<=0)){var P,D;const G=(((P=a.flip)==null?void 0:P.index)||0)+1,_t=_[G];if(_t)return{data:{index:G,overflows:F},reset:{placement:_t}};let rt=(D=F.filter(bt=>bt.overflows[0]<=0).sort((bt,Lt)=>bt.overflows[1]-Lt.overflows[1])[0])==null?void 0:D.placement;if(!rt)switch(m){case"bestFit":{var pt;const bt=(pt=F.map(Lt=>[Lt.placement,Lt.overflows.filter(Gt=>Gt>0).reduce((Gt,Zo)=>Gt+Zo,0)]).sort((Lt,Gt)=>Lt[1]-Gt[1])[0])==null?void 0:pt[0];bt&&(rt=bt);break}case"initialPlacement":rt=d;break}if(o!==rt)return{reset:{placement:rt}}}return{}}}};async function ha(t,e){const{placement:i,platform:s,elements:o}=t,a=await(s.isRTL==null?void 0:s.isRTL(o.floating)),n=se(i),d=Ee(i),c=ai(i)==="y",h=["left","top"].includes(n)?-1:1,f=a&&c?-1:1,u=Ae(e,t);let{mainAxis:p,crossAxis:m,alignmentAxis:b}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...u};return d&&typeof b=="number"&&(m=d==="end"?b*-1:b),c?{x:m*f,y:p*h}:{x:p*h,y:m*f}}const ua=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(e){var i,s;const{x:o,y:a,placement:n,middlewareData:d}=e,c=await ha(e,t);return n===((i=d.offset)==null?void 0:i.placement)&&(s=d.arrow)!=null&&s.alignmentOffset?{}:{x:o+c.x,y:a+c.y,data:{...c,placement:n}}}}},pa=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(e){const{x:i,y:s,placement:o}=e,{mainAxis:a=!0,crossAxis:n=!1,limiter:d={fn:$=>{let{x:E,y:w}=$;return{x:E,y:w}}},...c}=Ae(t,e),h={x:i,y:s},f=await xs(e,c),u=ai(se(o)),p=Ao(u);let m=h[p],b=h[u];if(a){const $=p==="y"?"top":"left",E=p==="y"?"bottom":"right",w=m+f[$],C=m-f[E];m=rs(w,m,C)}if(n){const $=u==="y"?"top":"left",E=u==="y"?"bottom":"right",w=b+f[$],C=b-f[E];b=rs(w,b,C)}const v=d.fn({...e,[p]:m,[u]:b});return{...v,data:{x:v.x-i,y:v.y-s}}}}},fa=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(e){const{placement:i,rects:s,platform:o,elements:a}=e,{apply:n=()=>{},...d}=Ae(t,e),c=await xs(e,d),h=se(i),f=Ee(i),u=ai(i)==="y",{width:p,height:m}=s.floating;let b,v;h==="top"||h==="bottom"?(b=h,v=f===(await(o.isRTL==null?void 0:o.isRTL(a.floating))?"start":"end")?"left":"right"):(v=h,b=f==="end"?"top":"bottom");const $=m-c[b],E=p-c[v],w=!e.middlewareData.shift;let C=$,g=E;if(u){const A=p-c.left-c.right;g=f||w?ie(E,A):A}else{const A=m-c.top-c.bottom;C=f||w?ie($,A):A}if(w&&!f){const A=kt(c.left,0),M=kt(c.right,0),F=kt(c.top,0),P=kt(c.bottom,0);u?g=p-2*(A!==0||M!==0?A+M:kt(c.left,c.right)):C=m-2*(F!==0||P!==0?F+P:kt(c.top,c.bottom))}await n({...e,availableWidth:g,availableHeight:C});const _=await o.getDimensions(a.floating);return p!==_.width||m!==_.height?{reset:{rects:!0}}:{}}}};function Di(){return typeof window<"u"}function Te(t){return To(t)?(t.nodeName||"").toLowerCase():"#document"}function $t(t){var e;return(t==null||(e=t.ownerDocument)==null?void 0:e.defaultView)||window}function qt(t){var e;return(e=(To(t)?t.ownerDocument:t.document)||window.document)==null?void 0:e.documentElement}function To(t){return Di()?t instanceof Node||t instanceof $t(t).Node:!1}function Dt(t){return Di()?t instanceof Element||t instanceof $t(t).Element:!1}function Wt(t){return Di()?t instanceof HTMLElement||t instanceof $t(t).HTMLElement:!1}function Ys(t){return!Di()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof $t(t).ShadowRoot}function ni(t){const{overflow:e,overflowX:i,overflowY:s,display:o}=Pt(t);return/auto|scroll|overlay|hidden|clip/.test(e+s+i)&&!["inline","contents"].includes(o)}function ma(t){return["table","td","th"].includes(Te(t))}function Pi(t){return[":popover-open",":modal"].some(e=>{try{return t.matches(e)}catch{return!1}})}function Mi(t){const e=ks(),i=Dt(t)?Pt(t):t;return["transform","translate","scale","rotate","perspective"].some(s=>i[s]?i[s]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!e&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!e&&(i.filter?i.filter!=="none":!1)||["transform","translate","scale","rotate","perspective","filter"].some(s=>(i.willChange||"").includes(s))||["paint","layout","strict","content"].some(s=>(i.contain||"").includes(s))}function ba(t){let e=oe(t);for(;Wt(e)&&!Se(e);){if(Mi(e))return e;if(Pi(e))return null;e=oe(e)}return null}function ks(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function Se(t){return["html","body","#document"].includes(Te(t))}function Pt(t){return $t(t).getComputedStyle(t)}function Ri(t){return Dt(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function oe(t){if(Te(t)==="html")return t;const e=t.assignedSlot||t.parentNode||Ys(t)&&t.host||qt(t);return Ys(e)?e.host:e}function Io(t){const e=oe(t);return Se(e)?t.ownerDocument?t.ownerDocument.body:t.body:Wt(e)&&ni(e)?e:Io(e)}function Je(t,e,i){var s;e===void 0&&(e=[]),i===void 0&&(i=!0);const o=Io(t),a=o===((s=t.ownerDocument)==null?void 0:s.body),n=$t(o);if(a){const d=ns(n);return e.concat(n,n.visualViewport||[],ni(o)?o:[],d&&i?Je(d):[])}return e.concat(o,Je(o,[],i))}function ns(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function Oo(t){const e=Pt(t);let i=parseFloat(e.width)||0,s=parseFloat(e.height)||0;const o=Wt(t),a=o?t.offsetWidth:i,n=o?t.offsetHeight:s,d=zi(i)!==a||zi(s)!==n;return d&&(i=a,s=n),{width:i,height:s,$:d}}function Cs(t){return Dt(t)?t:t.contextElement}function ke(t){const e=Cs(t);if(!Wt(e))return Ut(1);const i=e.getBoundingClientRect(),{width:s,height:o,$:a}=Oo(e);let n=(a?zi(i.width):i.width)/s,d=(a?zi(i.height):i.height)/o;return(!n||!Number.isFinite(n))&&(n=1),(!d||!Number.isFinite(d))&&(d=1),{x:n,y:d}}const ga=Ut(0);function Lo(t){const e=$t(t);return!ks()||!e.visualViewport?ga:{x:e.visualViewport.offsetLeft,y:e.visualViewport.offsetTop}}function va(t,e,i){return e===void 0&&(e=!1),!i||e&&i!==$t(t)?!1:e}function me(t,e,i,s){e===void 0&&(e=!1),i===void 0&&(i=!1);const o=t.getBoundingClientRect(),a=Cs(t);let n=Ut(1);e&&(s?Dt(s)&&(n=ke(s)):n=ke(t));const d=va(a,i,s)?Lo(a):Ut(0);let c=(o.left+d.x)/n.x,h=(o.top+d.y)/n.y,f=o.width/n.x,u=o.height/n.y;if(a){const p=$t(a),m=s&&Dt(s)?$t(s):s;let b=p,v=ns(b);for(;v&&s&&m!==b;){const $=ke(v),E=v.getBoundingClientRect(),w=Pt(v),C=E.left+(v.clientLeft+parseFloat(w.paddingLeft))*$.x,g=E.top+(v.clientTop+parseFloat(w.paddingTop))*$.y;c*=$.x,h*=$.y,f*=$.x,u*=$.y,c+=C,h+=g,b=$t(v),v=ns(b)}}return Ei({width:f,height:u,x:c,y:h})}function $s(t,e){const i=Ri(t).scrollLeft;return e?e.left+i:me(qt(t)).left+i}function Do(t,e,i){i===void 0&&(i=!1);const s=t.getBoundingClientRect(),o=s.left+e.scrollLeft-(i?0:$s(t,s)),a=s.top+e.scrollTop;return{x:o,y:a}}function ya(t){let{elements:e,rect:i,offsetParent:s,strategy:o}=t;const a=o==="fixed",n=qt(s),d=e?Pi(e.floating):!1;if(s===n||d&&a)return i;let c={scrollLeft:0,scrollTop:0},h=Ut(1);const f=Ut(0),u=Wt(s);if((u||!u&&!a)&&((Te(s)!=="body"||ni(n))&&(c=Ri(s)),Wt(s))){const m=me(s);h=ke(s),f.x=m.x+s.clientLeft,f.y=m.y+s.clientTop}const p=n&&!u&&!a?Do(n,c,!0):Ut(0);return{width:i.width*h.x,height:i.height*h.y,x:i.x*h.x-c.scrollLeft*h.x+f.x+p.x,y:i.y*h.y-c.scrollTop*h.y+f.y+p.y}}function _a(t){return Array.from(t.getClientRects())}function wa(t){const e=qt(t),i=Ri(t),s=t.ownerDocument.body,o=kt(e.scrollWidth,e.clientWidth,s.scrollWidth,s.clientWidth),a=kt(e.scrollHeight,e.clientHeight,s.scrollHeight,s.clientHeight);let n=-i.scrollLeft+$s(t);const d=-i.scrollTop;return Pt(s).direction==="rtl"&&(n+=kt(e.clientWidth,s.clientWidth)-o),{width:o,height:a,x:n,y:d}}function xa(t,e){const i=$t(t),s=qt(t),o=i.visualViewport;let a=s.clientWidth,n=s.clientHeight,d=0,c=0;if(o){a=o.width,n=o.height;const h=ks();(!h||h&&e==="fixed")&&(d=o.offsetLeft,c=o.offsetTop)}return{width:a,height:n,x:d,y:c}}function ka(t,e){const i=me(t,!0,e==="fixed"),s=i.top+t.clientTop,o=i.left+t.clientLeft,a=Wt(t)?ke(t):Ut(1),n=t.clientWidth*a.x,d=t.clientHeight*a.y,c=o*a.x,h=s*a.y;return{width:n,height:d,x:c,y:h}}function Gs(t,e,i){let s;if(e==="viewport")s=xa(t,i);else if(e==="document")s=wa(qt(t));else if(Dt(e))s=ka(e,i);else{const o=Lo(t);s={x:e.x-o.x,y:e.y-o.y,width:e.width,height:e.height}}return Ei(s)}function Po(t,e){const i=oe(t);return i===e||!Dt(i)||Se(i)?!1:Pt(i).position==="fixed"||Po(i,e)}function Ca(t,e){const i=e.get(t);if(i)return i;let s=Je(t,[],!1).filter(d=>Dt(d)&&Te(d)!=="body"),o=null;const a=Pt(t).position==="fixed";let n=a?oe(t):t;for(;Dt(n)&&!Se(n);){const d=Pt(n),c=Mi(n);!c&&d.position==="fixed"&&(o=null),(a?!c&&!o:!c&&d.position==="static"&&!!o&&["absolute","fixed"].includes(o.position)||ni(n)&&!c&&Po(t,n))?s=s.filter(f=>f!==n):o=d,n=oe(n)}return e.set(t,s),s}function $a(t){let{element:e,boundary:i,rootBoundary:s,strategy:o}=t;const n=[...i==="clippingAncestors"?Pi(e)?[]:Ca(e,this._c):[].concat(i),s],d=n[0],c=n.reduce((h,f)=>{const u=Gs(e,f,o);return h.top=kt(u.top,h.top),h.right=ie(u.right,h.right),h.bottom=ie(u.bottom,h.bottom),h.left=kt(u.left,h.left),h},Gs(e,d,o));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}}function Sa(t){const{width:e,height:i}=Oo(t);return{width:e,height:i}}function za(t,e,i){const s=Wt(e),o=qt(e),a=i==="fixed",n=me(t,!0,a,e);let d={scrollLeft:0,scrollTop:0};const c=Ut(0);if(s||!s&&!a)if((Te(e)!=="body"||ni(o))&&(d=Ri(e)),s){const p=me(e,!0,a,e);c.x=p.x+e.clientLeft,c.y=p.y+e.clientTop}else o&&(c.x=$s(o));const h=o&&!s&&!a?Do(o,d):Ut(0),f=n.left+d.scrollLeft-c.x-h.x,u=n.top+d.scrollTop-c.y-h.y;return{x:f,y:u,width:n.width,height:n.height}}function Xi(t){return Pt(t).position==="static"}function Qs(t,e){if(!Wt(t)||Pt(t).position==="fixed")return null;if(e)return e(t);let i=t.offsetParent;return qt(t)===i&&(i=i.ownerDocument.body),i}function Mo(t,e){const i=$t(t);if(Pi(t))return i;if(!Wt(t)){let o=oe(t);for(;o&&!Se(o);){if(Dt(o)&&!Xi(o))return o;o=oe(o)}return i}let s=Qs(t,e);for(;s&&ma(s)&&Xi(s);)s=Qs(s,e);return s&&Se(s)&&Xi(s)&&!Mi(s)?i:s||ba(t)||i}const Aa=async function(t){const e=this.getOffsetParent||Mo,i=this.getDimensions,s=await i(t.floating);return{reference:za(t.reference,await e(t.floating),t.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}};function Ea(t){return Pt(t).direction==="rtl"}const wi={convertOffsetParentRelativeRectToViewportRelativeRect:ya,getDocumentElement:qt,getClippingRect:$a,getOffsetParent:Mo,getElementRects:Aa,getClientRects:_a,getDimensions:Sa,getScale:ke,isElement:Dt,isRTL:Ea};function Ro(t,e){return t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}function Ta(t,e){let i=null,s;const o=qt(t);function a(){var d;clearTimeout(s),(d=i)==null||d.disconnect(),i=null}function n(d,c){d===void 0&&(d=!1),c===void 0&&(c=1),a();const h=t.getBoundingClientRect(),{left:f,top:u,width:p,height:m}=h;if(d||e(),!p||!m)return;const b=fi(u),v=fi(o.clientWidth-(f+p)),$=fi(o.clientHeight-(u+m)),E=fi(f),C={rootMargin:-b+"px "+-v+"px "+-$+"px "+-E+"px",threshold:kt(0,ie(1,c))||1};let g=!0;function _(A){const M=A[0].intersectionRatio;if(M!==c){if(!g)return n();M?n(!1,M):s=setTimeout(()=>{n(!1,1e-7)},1e3)}M===1&&!Ro(h,t.getBoundingClientRect())&&n(),g=!1}try{i=new IntersectionObserver(_,{...C,root:o.ownerDocument})}catch{i=new IntersectionObserver(_,C)}i.observe(t)}return n(!0),a}function Ia(t,e,i,s){s===void 0&&(s={});const{ancestorScroll:o=!0,ancestorResize:a=!0,elementResize:n=typeof ResizeObserver=="function",layoutShift:d=typeof IntersectionObserver=="function",animationFrame:c=!1}=s,h=Cs(t),f=o||a?[...h?Je(h):[],...Je(e)]:[];f.forEach(E=>{o&&E.addEventListener("scroll",i,{passive:!0}),a&&E.addEventListener("resize",i)});const u=h&&d?Ta(h,i):null;let p=-1,m=null;n&&(m=new ResizeObserver(E=>{let[w]=E;w&&w.target===h&&m&&(m.unobserve(e),cancelAnimationFrame(p),p=requestAnimationFrame(()=>{var C;(C=m)==null||C.observe(e)})),i()}),h&&!c&&m.observe(h),m.observe(e));let b,v=c?me(t):null;c&&$();function $(){const E=me(t);v&&!Ro(v,E)&&i(),v=E,b=requestAnimationFrame($)}return i(),()=>{var E;f.forEach(w=>{o&&w.removeEventListener("scroll",i),a&&w.removeEventListener("resize",i)}),u==null||u(),(E=m)==null||E.disconnect(),m=null,c&&cancelAnimationFrame(b)}}const Oa=ua,La=pa,Da=da,Zs=fa,Pa=ca,Ma=(t,e,i)=>{const s=new Map,o={platform:wi,...i},a={...o.platform,_c:s};return la(t,e,{...o,platform:a})};function Ra(t){return Fa(t)}function Yi(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function Fa(t){for(let e=t;e;e=Yi(e))if(e instanceof Element&&getComputedStyle(e).display==="none")return null;for(let e=Yi(t);e;e=Yi(e)){if(!(e instanceof Element))continue;const i=getComputedStyle(e);if(i.display!=="contents"&&(i.position!=="static"||Mi(i)||e.tagName==="BODY"))return e}return null}function Va(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t.contextElement instanceof Element:!0)}var W=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const t=this.anchorEl.getBoundingClientRect(),e=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let s=0,o=0,a=0,n=0,d=0,c=0,h=0,f=0;i?t.top<e.top?(s=t.left,o=t.bottom,a=t.right,n=t.bottom,d=e.left,c=e.top,h=e.right,f=e.top):(s=e.left,o=e.bottom,a=e.right,n=e.bottom,d=t.left,c=t.top,h=t.right,f=t.top):t.left<e.left?(s=t.right,o=t.top,a=e.left,n=e.top,d=t.right,c=t.bottom,h=e.left,f=e.bottom):(s=e.right,o=e.top,a=t.left,n=t.top,d=e.right,c=e.bottom,h=t.left,f=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${s}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${a}px`),this.style.setProperty("--hover-bridge-top-right-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${h}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${f}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||Va(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=Ia(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl)return;const t=[Oa({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(Zs({apply:({rects:i})=>{const s=this.sync==="width"||this.sync==="both",o=this.sync==="height"||this.sync==="both";this.popup.style.width=s?`${i.reference.width}px`:"",this.popup.style.height=o?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&t.push(Da({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(La({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?t.push(Zs({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:s})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${s}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(Pa({element:this.arrowEl,padding:this.arrowPadding}));const e=this.strategy==="absolute"?i=>wi.getOffsetParent(i,Ra):wi.getOffsetParent;Ma(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.strategy,platform:ti(Qt({},wi),{getOffsetParent:e})}).then(({x:i,y:s,middlewareData:o,placement:a})=>{const n=this.localize.dir()==="rtl",d={top:"bottom",right:"left",bottom:"top",left:"right"}[a.split("-")[0]];if(this.setAttribute("data-current-placement",a),Object.assign(this.popup.style,{left:`${i}px`,top:`${s}px`}),this.arrow){const c=o.arrow.x,h=o.arrow.y;let f="",u="",p="",m="";if(this.arrowPlacement==="start"){const b=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";f=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",u=n?b:"",m=n?"":b}else if(this.arrowPlacement==="end"){const b=typeof c=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=n?"":b,m=n?b:"",p=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(m=typeof c=="number"?"calc(50% - var(--arrow-size-diagonal))":"",f=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(m=typeof c=="number"?`${c}px`:"",f=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:f,right:u,bottom:p,left:m,[d]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return y`
    ...
    `}};at.styles=[L,Jr];at.dependencies={"sl-popup":W};r([k("slot:not([name])")],at.prototype,"defaultSlot",2);r([k(".tooltip__body")],at.prototype,"body",2);r([k("sl-popup")],at.prototype,"popup",2);r([l()],at.prototype,"content",2);r([l()],at.prototype,"placement",2);r([l({type:Boolean,reflect:!0})],at.prototype,"disabled",2);r([l({type:Number})],at.prototype,"distance",2);r([l({type:Boolean,reflect:!0})],at.prototype,"open",2);r([l({type:Number})],at.prototype,"skidding",2);r([l()],at.prototype,"trigger",2);r([l({type:Boolean})],at.prototype,"hoist",2);r([x("open",{waitUntilFirstUpdate:!0})],at.prototype,"handleOpenChange",1);r([x(["content","distance","hoist","placement","skidding"])],at.prototype,"handleOptionsChange",1);r([x("disabled")],at.prototype,"handleDisabledChange",1);U("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});U("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});at.define("sl-tooltip");var Ba=T`
  :host {
    /*
...
`;function et(t,e,i){const s=o=>Object.is(o,-0)?0:o;return t<e?s(e):t>i?s(i):s(t)}function Js(t,e=!1){function i(a){const n=a.getChildrenItems({includeDisabled:!1});if(n.length){const d=n.every(h=>h.selected),c=n.every(h=>!h.selected&&!h.indeterminate);a.selected=d,a.indeterminate=!d&&!c}}function s(a){const n=a.parentElement;We.isTreeItem(n)&&(i(n),s(n))}function o(a){for(const n of a.getChildrenItems())n.selected=e?a.selected||n.selected:!n.disabled&&a.selected,o(n);e&&i(a)}o(t),s(t)}var ge=class extends z{constructor(){super(),this.selection="single",this.clickTarget=null,this.localize=new H(this),this.initTreeItem=t=>{t.selectable=this.selection==="multiple",["expand","collapse"].filter(e=>!!this.querySelector(`[slot="${e}-icon"]`)).forEach(e=>{const i=t.querySelector(`[slot="${e}-icon"]`),s=this.getExpandButtonIcon(e);s&&(i===null?t.append(s):i.hasAttribute("data-default")&&i.replaceWith(s))})},this.handleTreeChanged=t=>{for(const e of t){const i=[...e.addedNodes].filter(We.isTreeItem),s=[...e.removedNodes].filter(We.isTreeItem);i.forEach(this.initTreeItem),this.lastFocusedItem&&s.includes(this.lastFocusedItem)&&(this.lastFocusedItem=null)}},this.handleFocusOut=t=>{const e=t.relatedTarget;(!e||!this.contains(e))&&(this.tabIndex=0)},this.handleFocusIn=t=>{const e=t.target;t.target===this&&this.focusItem(this.lastFocusedItem||this.getAllTreeItems()[0]),We.isTreeItem(e)&&!e.disabled&&(this.lastFocusedItem&&(this.lastFocusedItem.tabIndex=-1),this.lastFocusedItem=e,this.tabIndex=-1,e.tabIndex=0)},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut),this.addEventListener("sl-lazy-change",this.handleSlotChange)}async connectedCallback(){super.connectedCallback(),this.setAttribute("role","tree"),this.setAttribute("tabindex","0"),await this.updateComplete,this.mutationObserver=new MutationObserver(this.handleTreeChanged),this.mutationObserver.observe(this,{childList:!0,subtree:!0})}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this.mutationObserver)==null||t.disconnect()}getExpandButtonIcon(t){const i=(t==="expand"?this.expandedIconSlot:this.collapsedIconSlot).assignedElements({flatten:!0})[0];if(i){const s=i.cloneNode(!0);return[s,...s.querySelectorAll("[id]")].forEach(o=>o.removeAttribute("id")),s.setAttribute("data-default",""),s.slot=`${t}-icon`,s}return null}selectItem(t){const e=[...this.selectedItems];if(this.selection==="multiple")t.selected=!t.selected,t.lazy&&(t.expanded=!0),Js(t);else if(this.selection==="single"||t.isLeaf){const s=this.getAllTreeItems();for(const o of s)o.selected=o===t}else this.selection==="leaf"&&(t.expanded=!t.expanded);const i=this.selectedItems;(e.length!==i.length||i.some(s=>!e.includes(s)))&&Promise.all(i.map(s=>s.updateComplete)).then(()=>{this.emit("sl-selection-change",{detail:{selection:i}})})}getAllTreeItems(){return[...this.querySelectorAll("sl-tree-item")]}focusItem(t){t==null||t.focus()}handleKeyDown(t){if(!["ArrowDown","ArrowUp","ArrowRight","ArrowLeft","Home","End","Enter"," "].includes(t.key)||t.composedPath().some(o=>{var a;return["input","textarea"].includes((a=o==null?void 0:o.tagName)==null?void 0:a.toLowerCase())}))return;const e=this.getFocusableItems(),i=this.localize.dir()==="ltr",s=this.localize.dir()==="rtl";if(e.length>0){t.preventDefault();const o=e.findIndex(c=>c.matches(":focus")),a=e[o],n=c=>{const h=e[et(c,0,e.length-1)];this.focusItem(h)},d=c=>{a.expanded=c};t.key==="ArrowDown"?n(o+1):t.key==="ArrowUp"?n(o-1):i&&t.key==="ArrowRight"||s&&t.key==="ArrowLeft"?!a||a.disabled||a.expanded||a.isLeaf&&!a.lazy?n(o+1):d(!0):i&&t.key==="ArrowLeft"||s&&t.key==="ArrowRight"?!a||a.disabled||a.isLeaf||!a.expanded?n(o-1):d(!1):t.key==="Home"?n(0):t.key==="End"?n(e.length-1):(t.key==="Enter"||t.key===" ")&&(a.disabled||this.selectItem(a))}}handleClick(t){const e=t.target,i=e.closest("sl-tree-item"),s=t.composedPath().some(o=>{var a;return(a=o==null?void 0:o.classList)==null?void 0:a.contains("tree-item__expand-button")});!i||i.disabled||e!==this.clickTarget||(s?i.expanded=!i.expanded:this.selectItem(i))}handleMouseDown(t){this.clickTarget=t.target}handleSlotChange(){this.getAllTreeItems().forEach(this.initTreeItem)}async handleSelectionChange(){const t=this.selection==="multiple",e=this.getAllTreeItems();this.setAttribute("aria-multiselectable",t?"true":"false");for(const i of e)i.selectable=t;t&&(await this.updateComplete,[...this.querySelectorAll(":scope > sl-tree-item")].forEach(i=>Js(i,!0)))}get selectedItems(){const t=this.getAllTreeItems(),e=i=>i.selected;return t.filter(e)}getFocusableItems(){const t=this.getAllTreeItems(),e=new Set;return t.filter(i=>{var s;if(i.disabled)return!1;const o=(s=i.parentElement)==null?void 0:s.closest("[role=treeitem]");return o&&(!o.expanded||o.loading||e.has(o))&&e.add(i),!e.has(i)})}render(){return y`
    ...
    `}};ge.styles=[L,Ba];r([k("slot:not([name])")],ge.prototype,"defaultSlot",2);r([k("slot[name=expand-icon]")],ge.prototype,"expandedIconSlot",2);r([k("slot[name=collapse-icon]")],ge.prototype,"collapsedIconSlot",2);r([l()],ge.prototype,"selection",2);r([x("selection")],ge.prototype,"handleSelectionChange",1);ge.define("sl-tree");var Ha=T`
...
`,Ss=class extends z{render(){return y` <slot></slot> `}};Ss.styles=[L,Ha];Ss.define("sl-visually-hidden");var Na=T`
  :host {
    --padding: 0;
...
`,Ua=0,li=class extends z{constructor(){super(...arguments),this.attrId=++Ua,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return y`
      <slot
        part="base"
        class=${O({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};li.styles=[L,Na];r([l({reflect:!0})],li.prototype,"name",2);r([l({type:Boolean,reflect:!0})],li.prototype,"active",2);r([x("active")],li.prototype,"handleActiveChange",1);li.define("sl-tab-panel");var Wa=T`
  :host {
    display: inline-block;
  }
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fo=Symbol.for(""),ja=t=>{if((t==null?void 0:t.r)===Fo)return t==null?void 0:t._$litStatic$},Ti=(t,...e)=>({_$litStatic$:e.reduce((i,s,o)=>i+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+t[o+1],t[0]),r:Fo}),to=new Map,Ka=t=>(e,...i)=>{const s=i.length;let o,a;const n=[],d=[];let c,h=0,f=!1;for(;h<s;){for(c=e[h];h<s&&(a=i[h],(o=ja(a))!==void 0);)c+=o+e[++h],f=!0;h!==s&&d.push(a),n.push(c),h++}if(h===s&&n.push(e[s]),f){const u=n.join("$$lit$$");(e=to.get(u))===void 0&&(n.raw=n,to.set(u,e=n)),i=d}return t(e,...i)},qe=Ka(y);var ot=class extends z{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?Ti`a`:Ti`button`;return qe`
      <${e}
        part="base"
    ...
    `}};ot.styles=[L,qa];ot.dependencies={"sl-icon":j};r([k(".icon-button")],ot.prototype,"button",2);r([I()],ot.prototype,"hasFocus",2);r([l()],ot.prototype,"name",2);r([l()],ot.prototype,"library",2);r([l()],ot.prototype,"src",2);r([l()],ot.prototype,"href",2);r([l()],ot.prototype,"target",2);r([l()],ot.prototype,"download",2);r([l()],ot.prototype,"label",2);r([l({type:Boolean,reflect:!0})],ot.prototype,"disabled",2);var re=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return y`
      <span
        part="base"
    ...
    `}};re.styles=[L,Wa];re.dependencies={"sl-icon-button":ot};r([l({reflect:!0})],re.prototype,"variant",2);r([l({reflect:!0})],re.prototype,"size",2);r([l({type:Boolean,reflect:!0})],re.prototype,"pill",2);r([l({type:Boolean})],re.prototype,"removable",2);re.define("sl-tag");var Xa=T`
  :host {
    display: block;
  }
...
`,N=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new vt(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.filled=!1,this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){var t;super.disconnectedCallback(),this.input&&((t=this.resizeObserver)==null||t.unobserve(this.input))}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleInput(){this.value=this.input.value,this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=""}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(t){this.input.focus(t)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(t){if(t){typeof t.top=="number"&&(this.input.scrollTop=t.top),typeof t.left=="number"&&(this.input.scrollLeft=t.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(t,e,i="none"){this.input.setSelectionRange(t,e,i)}setRangeText(t,e,i,s="preserve"){const o=e??this.input.selectionStart,a=i??this.input.selectionEnd;this.input.setRangeText(t,o,a,s),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("label"),e=this.hasSlotController.test("help-text"),i=this.label?!0:!!t,s=this.helpText?!0:!!e;return y`
    ...
    `}};N.styles=[L,be,Xa];r([k(".textarea__control")],N.prototype,"input",2);r([k(".textarea__size-adjuster")],N.prototype,"sizeAdjuster",2);r([I()],N.prototype,"hasFocus",2);r([l()],N.prototype,"title",2);r([l()],N.prototype,"name",2);r([l()],N.prototype,"value",2);r([l({reflect:!0})],N.prototype,"size",2);r([l({type:Boolean,reflect:!0})],N.prototype,"filled",2);r([l()],N.prototype,"label",2);r([l({attribute:"help-text"})],N.prototype,"helpText",2);r([l()],N.prototype,"placeholder",2);r([l({type:Number})],N.prototype,"rows",2);r([l()],N.prototype,"resize",2);r([l({type:Boolean,reflect:!0})],N.prototype,"disabled",2);r([l({type:Boolean,reflect:!0})],N.prototype,"readonly",2);r([l({reflect:!0})],N.prototype,"form",2);r([l({type:Boolean,reflect:!0})],N.prototype,"required",2);r([l({type:Number})],N.prototype,"minlength",2);r([l({type:Number})],N.prototype,"maxlength",2);r([l()],N.prototype,"autocapitalize",2);r([l()],N.prototype,"autocorrect",2);r([l()],N.prototype,"autocomplete",2);r([l({type:Boolean})],N.prototype,"autofocus",2);r([l()],N.prototype,"enterkeyhint",2);r([l({type:Boolean,converter:{fromAttribute:t=>!(!t||t==="false"),toAttribute:t=>t?"true":"false"}})],N.prototype,"spellcheck",2);r([l()],N.prototype,"inputmode",2);r([ze()],N.prototype,"defaultValue",2);r([x("disabled",{waitUntilFirstUpdate:!0})],N.prototype,"handleDisabledChange",1);r([x("rows",{waitUntilFirstUpdate:!0})],N.prototype,"handleRowsChange",1);r([x("value",{waitUntilFirstUpdate:!0})],N.prototype,"handleValueChange",1);N.define("sl-textarea");var Ya=T`
  :host {
    display: inline-block;
  }
...
`,Ga=0,Mt=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.attrId=++Ga,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(t){t.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,y`
      <div
        part="base"
...
`,zs=class extends z{constructor(){super(...arguments),this.effect="none"}render(){return y`
    ...
    `}};zs.styles=[L,sn];r([l()],zs.prototype,"effect",2);zs.define("sl-skeleton");var on=T`
  :host {
    --divider-width: 4px;
...
`,ft=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{value:t=>t.checked?t.value||"on":void 0,defaultValue:t=>t.defaultChecked,setValue:(t,e)=>t.checked=e}),this.hasSlotController=new vt(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}handleClick(){this.checked=!this.checked,this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleKeyDown(t){t.key==="ArrowLeft"&&(t.preventDefault(),this.checked=!1,this.emit("sl-change"),this.emit("sl-input")),t.key==="ArrowRight"&&(t.preventDefault(),this.checked=!0,this.emit("sl-change"),this.emit("sl-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(t){this.input.focus(t)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(t){this.input.setCustomValidity(t),this.formControlController.updateValidity()}render(){const t=this.hasSlotController.test("help-text"),e=this.helpText?!0:!!t;return y`
    ...
    `}};ft.styles=[L,be,rn];r([k('input[type="checkbox"]')],ft.prototype,"input",2);r([I()],ft.prototype,"hasFocus",2);r([l()],ft.prototype,"title",2);r([l()],ft.prototype,"name",2);r([l()],ft.prototype,"value",2);r([l({reflect:!0})],ft.prototype,"size",2);r([l({type:Boolean,reflect:!0})],ft.prototype,"disabled",2);r([l({type:Boolean,reflect:!0})],ft.prototype,"checked",2);r([ze("checked")],ft.prototype,"defaultChecked",2);r([l({reflect:!0})],ft.prototype,"form",2);r([l({type:Boolean,reflect:!0})],ft.prototype,"required",2);r([l({attribute:"help-text"})],ft.prototype,"helpText",2);r([x("checked",{waitUntilFirstUpdate:!0})],ft.prototype,"handleCheckedChange",1);r([x("disabled",{waitUntilFirstUpdate:!0})],ft.prototype,"handleDisabledChange",1);ft.define("sl-switch");ci.define("sl-resize-observer");var an=T`
  :host {
    display: block;
  }
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ds=class extends oi{constructor(e){if(super(e),this.it=K,e.type!==Nt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===K||e==null)return this._t=void 0,this.it=e;if(e===Ct)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};ds.directiveName="unsafeHTML",ds.resultType=1;const xi=si(ds);var V=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new vt(this,"help-text","label"),this.localize=new H(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.filled=!1,this.pill=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=t=>y`
      <sl-tag
        part="tag"
        exportparts="
              base:tag__base,
 ...
 */const Vo="important",cn=" !"+Vo,yt=si(class extends oi{constructor(t){var e;if(super(t),t.type!==Nt.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const s=t[i];return s==null?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(t,[e]){const{style:i}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const s of this.ft)e[s]==null&&(this.ft.delete(s),s.includes("-")?i.removeProperty(s):i[s]=null);for(const s in e){const o=e[s];if(o!=null){this.ft.add(s);const a=typeof o=="string"&&o.endsWith(cn);s.includes("-")||a?i.setProperty(s,a?o.slice(0,-11):o,a?Vo:""):i[s]=o}}return Ct}});var mt=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.hoverValue=0,this.isHovering=!1,this.label="",this.value=0,this.max=5,this.precision=1,this.readonly=!1,this.disabled=!1,this.getSymbol=()=>'<sl-icon name="star-fill" library="system"></sl-icon>'}getValueFromMousePosition(t){return this.getValueFromXCoordinate(t.clientX)}getValueFromTouchPosition(t){return this.getValueFromXCoordinate(t.touches[0].clientX)}getValueFromXCoordinate(t){const e=this.localize.dir()==="rtl",{left:i,right:s,width:o}=this.rating.getBoundingClientRect(),a=e?this.roundToPrecision((s-t)/o*this.max,this.precision):this.roundToPrecision((t-i)/o*this.max,this.precision);return et(a,0,this.max)}handleClick(t){this.disabled||(this.setValue(this.getValueFromMousePosition(t)),this.emit("sl-change"))}setValue(t){this.disabled||this.readonly||(this.value=t===this.value?0:t,this.isHovering=!1)}handleKeyDown(t){const e=this.localize.dir()==="ltr",i=this.localize.dir()==="rtl",s=this.value;if(!(this.disabled||this.readonly)){if(t.key==="ArrowDown"||e&&t.key==="ArrowLeft"||i&&t.key==="ArrowRight"){const o=t.shiftKey?1:this.precision;this.value=Math.max(0,this.value-o),t.preventDefault()}if(t.key==="ArrowUp"||e&&t.key==="ArrowRight"||i&&t.key==="ArrowLeft"){const o=t.shiftKey?1:this.precision;this.value=Math.min(this.max,this.value+o),t.preventDefault()}t.key==="Home"&&(this.value=0,t.preventDefault()),t.key==="End"&&(this.value=this.max,t.preventDefault()),this.value!==s&&this.emit("sl-change")}}handleMouseEnter(t){this.isHovering=!0,this.hoverValue=this.getValueFromMousePosition(t)}handleMouseMove(t){this.hoverValue=this.getValueFromMousePosition(t)}handleMouseLeave(){this.isHovering=!1}handleTouchStart(t){this.isHovering=!0,this.hoverValue=this.getValueFromTouchPosition(t),t.preventDefault()}handleTouchMove(t){this.hoverValue=this.getValueFromTouchPosition(t)}handleTouchEnd(t){this.isHovering=!1,this.setValue(this.hoverValue),this.emit("sl-change"),t.preventDefault()}roundToPrecision(t,e=.5){const i=1/e;return Math.ceil(t*i)/i}handleHoverValueChange(){this.emit("sl-hover",{detail:{phase:"move",value:this.hoverValue}})}handleIsHoveringChange(){this.emit("sl-hover",{detail:{phase:this.isHovering?"start":"end",value:this.hoverValue}})}focus(t){this.rating.focus(t)}blur(){this.rating.blur()}render(){const t=this.localize.dir()==="rtl",e=Array.from(Array(this.max).keys());let i=0;return this.disabled||this.readonly?i=this.value:i=this.isHovering?this.hoverValue:this.value,y`
    ...
    `}};mt.styles=[L,ln];mt.dependencies={"sl-icon":j};r([k(".rating")],mt.prototype,"rating",2);r([I()],mt.prototype,"hoverValue",2);r([I()],mt.prototype,"isHovering",2);r([l()],mt.prototype,"label",2);r([l({type:Number})],mt.prototype,"value",2);r([l({type:Number})],mt.prototype,"max",2);r([l({type:Number})],mt.prototype,"precision",2);r([l({type:Boolean,reflect:!0})],mt.prototype,"readonly",2);r([l({type:Boolean,reflect:!0})],mt.prototype,"disabled",2);r([l()],mt.prototype,"getSymbol",2);r([ii({passive:!0})],mt.prototype,"handleTouchMove",1);r([x("hoverValue")],mt.prototype,"handleHoverValueChange",1);r([x("isHovering")],mt.prototype,"handleIsHoveringChange",1);mt.define("sl-rating");var dn=[{max:276e4,value:6e4,unit:"minute"},{max:72e6,value:36e5,unit:"hour"},{max:5184e5,value:864e5,unit:"day"},{max:24192e5,value:6048e5,unit:"week"},{max:28512e6,value:2592e6,unit:"month"},{max:1/0,value:31536e6,unit:"year"}],ve=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.isoTime="",this.relativeTime="",this.date=new Date,this.format="long",this.numeric="auto",this.sync=!1}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.updateTimeout)}render(){const t=new Date,e=new Date(this.date);if(isNaN(e.getMilliseconds()))return this.relativeTime="",this.isoTime="","";const i=e.getTime()-t.getTime(),{unit:s,value:o}=dn.find(a=>Math.abs(i)<a.max);if(this.isoTime=e.toISOString(),this.relativeTime=this.localize.relativeTime(Math.round(i/o),s,{numeric:this.numeric,style:this.format}),clearTimeout(this.updateTimeout),this.sync){let a;s==="minute"?a=mi("second"):s==="hour"?a=mi("minute"):s==="day"?a=mi("hour"):a=mi("day"),this.updateTimeout=window.setTimeout(()=>this.requestUpdate(),a)}return y` <time datetime=${this.isoTime}>${this.relativeTime}</time> `}};r([I()],ve.prototype,"isoTime",2);r([I()],ve.prototype,"relativeTime",2);r([l()],ve.prototype,"date",2);r([l()],ve.prototype,"format",2);r([l()],ve.prototype,"numeric",2);r([l({type:Boolean})],ve.prototype,"sync",2);function mi(t){const i={second:1e3,minute:6e4,hour:36e5,day:864e5}[t];return i-Date.now()%i}ve.define("sl-relative-time");var Bo=T`
  :host {
    display: inline-block;
    position: relative;
    width: auto;
...
`,Rt=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"[default]","prefix","suffix"),this.hasFocus=!1,this.checked=!1,this.disabled=!1,this.size="medium",this.pill=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","presentation")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleClick(t){if(this.disabled){t.preventDefault(),t.stopPropagation();return}this.checked=!0}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(t){this.input.focus(t)}blur(){this.input.blur()}render(){return qe`
    ...
    `}};Rt.styles=[L,hn];r([k(".button")],Rt.prototype,"input",2);r([k(".hidden-input")],Rt.prototype,"hiddenInput",2);r([I()],Rt.prototype,"hasFocus",2);r([l({type:Boolean,reflect:!0})],Rt.prototype,"checked",2);r([l()],Rt.prototype,"value",2);r([l({type:Boolean,reflect:!0})],Rt.prototype,"disabled",2);r([l({reflect:!0})],Rt.prototype,"size",2);r([l({type:Boolean,reflect:!0})],Rt.prototype,"pill",2);r([x("disabled",{waitUntilFirstUpdate:!0})],Rt.prototype,"handleDisabledChange",1);Rt.define("sl-radio-button");var un=T`
  :host {
    display: block;
  }
...
`,ye=class extends z{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(t){const e=Ve(t.target);e==null||e.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(t){const e=Ve(t.target);e==null||e.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(t){const e=Ve(t.target);e==null||e.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(t){const e=Ve(t.target);e==null||e.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})];t.forEach(e=>{const i=t.indexOf(e),s=Ve(e);s&&(s.toggleAttribute("data-sl-button-group__button",!0),s.toggleAttribute("data-sl-button-group__button--first",i===0),s.toggleAttribute("data-sl-button-group__button--inner",i>0&&i<t.length-1),s.toggleAttribute("data-sl-button-group__button--last",i===t.length-1),s.toggleAttribute("data-sl-button-group__button--radio",s.tagName.toLowerCase()==="sl-radio-button"))})}render(){return y`
    ...
    `}};ht.styles=[L,be,un];ht.dependencies={"sl-button-group":ye};r([k("slot:not([name])")],ht.prototype,"defaultSlot",2);r([k(".radio-group__validation-input")],ht.prototype,"validationInput",2);r([I()],ht.prototype,"hasButtonGroup",2);r([I()],ht.prototype,"errorMessage",2);r([I()],ht.prototype,"defaultValue",2);r([l()],ht.prototype,"label",2);r([l({attribute:"help-text"})],ht.prototype,"helpText",2);r([l()],ht.prototype,"name",2);r([l({reflect:!0})],ht.prototype,"value",2);r([l({reflect:!0})],ht.prototype,"size",2);r([l({reflect:!0})],ht.prototype,"form",2);r([l({type:Boolean,reflect:!0})],ht.prototype,"required",2);r([x("size",{waitUntilFirstUpdate:!0})],ht.prototype,"handleSizeChange",1);r([x("value")],ht.prototype,"handleValueChange",1);ht.define("sl-radio-group");var fn=T`
  :host {
    --size: 128px;
    --track-width: 4px;
    --track-color: var(--sl-color-neutral-200);
...
`,Ie=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.value=0,this.label=""}updated(t){if(super.updated(t),t.has("value")){const e=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*e,s=i-this.value/100*i;this.indicatorOffset=`${s}px`}}render(){return y`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
...
`;let Ho=null;class No{}No.render=function(t,e){Ho(t,e)};self.QrCreator=No;(function(t){function e(d,c,h,f){var u={},p=t(h,c);p.u(d),p.J(),f=f||0;var m=p.h(),b=p.h()+2*f;return u.text=d,u.level=c,u.version=h,u.O=b,u.a=function(v,$){return v-=f,$-=f,0>v||v>=m||0>$||$>=m?!1:p.a(v,$)},u}function i(d,c,h,f,u,p,m,b,v,$){function E(w,C,g,_,A,M,F){w?(d.lineTo(C+M,g+F),d.arcTo(C,g,_,A,p)):d.lineTo(C,g)}m?d.moveTo(c+p,h):d.moveTo(c,h),E(b,f,h,f,u,-p,0),E(v,f,u,c,u,0,-p),E($,c,u,c,h,p,0),E(m,c,h,f,h,0,p)}function s(d,c,h,f,u,p,m,b,v,$){function E(w,C,g,_){d.moveTo(w+g,C),d.lineTo(w,C),d.lineTo(w,C+_),d.arcTo(w,C,w+g,C,p)}m&&E(c,h,p,p),b&&E(f,h,-p,p),v&&E(f,u,-p,-p),$&&E(c,u,p,-p)}function o(d,c){var h=c.fill;if(typeof h=="string")d.fillStyle=h;else{var f=h.type,u=h.colorStops;if(h=h.position.map(m=>Math.round(m*c.size)),f==="linear-gradient")var p=d.createLinearGradient.apply(d,h);else if(f==="radial-gradient")p=d.createRadialGradient.apply(d,h);else throw Error("Unsupported fill");u.forEach(([m,b])=>{p.addColorStop(m,b)}),d.fillStyle=p}}function a(d,c){t:{var h=c.text,f=c.v,u=c.N,p=c.K,m=c.P;for(u=Math.max(1,u||1),p=Math.min(40,p||40);u<=p;u+=1)try{var b=e(h,f,u,m);break t}catch{}b=void 0}if(!b)return null;for(h=d.getContext("2d"),c.background&&(h.fillStyle=c.background,h.fillRect(c.left,c.top,c.size,c.size)),f=b.O,p=c.size/f,h.beginPath(),m=0;m<f;m+=1)for(u=0;u<f;u+=1){var v=h,$=c.left+u*p,E=c.top+m*p,w=m,C=u,g=b.a,_=$+p,A=E+p,M=w-1,F=w+1,P=C-1,D=C+1,pt=Math.floor(Math.min(.5,Math.max(0,c.R))*p),G=g(w,C),_t=g(M,P),rt=g(M,C);M=g(M,D);var bt=g(w,D);D=g(F,D),C=g(F,C),F=g(F,P),w=g(w,P),$=Math.round($),E=Math.round(E),_=Math.round(_),A=Math.round(A),G?i(v,$,E,_,A,pt,!rt&&!w,!rt&&!bt,!C&&!bt,!C&&!w):s(v,$,E,_,A,pt,rt&&w&&_t,rt&&bt&&M,C&&bt&&D,C&&w&&F)}return o(h,c),h.fill(),d}var n={minVersion:1,maxVersion:40,ecLevel:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",radius:.5,quiet:0};Ho=function(d,c){var h={};Object.assign(h,n,d),h.N=h.minVersion,h.K=h.maxVersion,h.v=h.ecLevel,h.left=h.left,h.top=h.top,h.size=h.size,h.fill=h.fill,h.background=h.background,h.text=h.text,h.R=h.radius,h.P=h.quiet,c instanceof HTMLCanvasElement?((c.width!==h.size||c.height!==h.size)&&(c.width=h.size,c.height=h.size),c.getContext("2d").clearRect(0,0,c.width,c.height),a(c,h)):(d=document.createElement("canvas"),d.width=h.size,d.height=h.size,h=a(d,h),c.appendChild(h))}})(function(){function t(c){var h=i.s(c);return{S:function(){return 4},b:function(){return h.length},write:function(f){for(var u=0;u<h.length;u+=1)f.put(h[u],8)}}}function e(){var c=[],h=0,f={B:function(){return c},c:function(u){return(c[Math.floor(u/8)]>>>7-u%8&1)==1},put:function(u,p){for(var m=0;m<p;m+=1)f.m((u>>>p-m-1&1)==1)},f:function(){return h},m:function(u){var p=Math.floor(h/8);c.length<=p&&c.push(0),u&&(c[p]|=128>>>h%8),h+=1}};return f}function i(c,h){function f(w,C){for(var g=-1;7>=g;g+=1)if(!(-1>=w+g||b<=w+g))for(var _=-1;7>=_;_+=1)-1>=C+_||b<=C+_||(m[w+g][C+_]=0<=g&&6>=g&&(_==0||_==6)||0<=_&&6>=_&&(g==0||g==6)||2<=g&&4>=g&&2<=_&&4>=_)}function u(w,C){for(var g=b=4*c+17,_=Array(g),A=0;A<g;A+=1){_[A]=Array(g);for(var M=0;M<g;M+=1)_[A][M]=null}for(m=_,f(0,0),f(b-7,0),f(0,b-7),g=a.G(c),_=0;_<g.length;_+=1)for(A=0;A<g.length;A+=1){M=g[_];var F=g[A];if(m[M][F]==null)for(var P=-2;2>=P;P+=1)for(var D=-2;2>=D;D+=1)m[M+P][F+D]=P==-2||P==2||D==-2||D==2||P==0&&D==0}for(g=8;g<b-8;g+=1)m[g][6]==null&&(m[g][6]=g%2==0);for(g=8;g<b-8;g+=1)m[6][g]==null&&(m[6][g]=g%2==0);for(g=a.w(p<<3|C),_=0;15>_;_+=1)A=!w&&(g>>_&1)==1,m[6>_?_:8>_?_+1:b-15+_][8]=A,m[8][8>_?b-_-1:9>_?15-_:14-_]=A;if(m[b-8][8]=!w,7<=c){for(g=a.A(c),_=0;18>_;_+=1)A=!w&&(g>>_&1)==1,m[Math.floor(_/3)][_%3+b-8-3]=A;for(_=0;18>_;_+=1)A=!w&&(g>>_&1)==1,m[_%3+b-8-3][Math.floor(_/3)]=A}if(v==null){for(w=d.I(c,p),g=e(),_=0;_<$.length;_+=1)A=$[_],g.put(4,4),g.put(A.b(),a.f(4,c)),A.write(g);for(_=A=0;_<w.length;_+=1)A+=w[_].j;if(g.f()>8*A)throw Error("code length overflow. ("+g.f()+">"+8*A+")");for(g.f()+4<=8*A&&g.put(0,4);g.f()%8!=0;)g.m(!1);for(;!(g.f()>=8*A)&&(g.put(236,8),!(g.f()>=8*A));)g.put(17,8);var pt=0;for(A=_=0,M=Array(w.length),F=Array(w.length),P=0;P<w.length;P+=1){var G=w[P].j,_t=w[P].o-G;for(_=Math.max(_,G),A=Math.max(A,_t),M[P]=Array(G),D=0;D<M[P].length;D+=1)M[P][D]=255&g.B()[D+pt];for(pt+=G,D=a.C(_t),G=s(M[P],D.b()-1).l(D),F[P]=Array(D.b()-1),D=0;D<F[P].length;D+=1)_t=D+G.b()-F[P].length,F[P][D]=0<=_t?G.c(_t):0}for(D=g=0;D<w.length;D+=1)g+=w[D].o;for(g=Array(g),D=pt=0;D<_;D+=1)for(P=0;P<w.length;P+=1)D<M[P].length&&(g[pt]=M[P][D],pt+=1);for(D=0;D<A;D+=1)for(P=0;P<w.length;P+=1)D<F[P].length&&(g[pt]=F[P][D],pt+=1);v=g}for(w=v,g=-1,_=b-1,A=7,M=0,C=a.F(C),F=b-1;0<F;F-=2)for(F==6&&--F;;){for(P=0;2>P;P+=1)m[_][F-P]==null&&(D=!1,M<w.length&&(D=(w[M]>>>A&1)==1),C(_,F-P)&&(D=!D),m[_][F-P]=D,--A,A==-1&&(M+=1,A=7));if(_+=g,0>_||b<=_){_-=g,g=-g;break}}}var p=o[h],m=null,b=0,v=null,$=[],E={u:function(w){w=t(w),$.push(w),v=null},a:function(w,C){if(0>w||b<=w||0>C||b<=C)throw Error(w+","+C);return m[w][C]},h:function(){return b},J:function(){for(var w=0,C=0,g=0;8>g;g+=1){u(!0,g);var _=a.D(E);(g==0||w>_)&&(w=_,C=g)}u(!1,C)}};return E}function s(c,h){if(typeof c.length>"u")throw Error(c.length+"/"+h);var f=function(){for(var p=0;p<c.length&&c[p]==0;)p+=1;for(var m=Array(c.length-p+h),b=0;b<c.length-p;b+=1)m[b]=c[b+p];return m}(),u={c:function(p){return f[p]},b:function(){return f.length},multiply:function(p){for(var m=Array(u.b()+p.b()-1),b=0;b<u.b();b+=1)for(var v=0;v<p.b();v+=1)m[b+v]^=n.i(n.g(u.c(b))+n.g(p.c(v)));return s(m,0)},l:function(p){if(0>u.b()-p.b())return u;for(var m=n.g(u.c(0))-n.g(p.c(0)),b=Array(u.b()),v=0;v<u.b();v+=1)b[v]=u.c(v);for(v=0;v<p.b();v+=1)b[v]^=n.i(n.g(p.c(v))+m);return s(b,0).l(p)}};return u}i.s=function(c){for(var h=[],f=0;f<c.length;f++){var u=c.charCodeAt(f);128>u?h.push(u):2048>u?h.push(192|u>>6,128|u&63):55296>u||57344<=u?h.push(224|u>>12,128|u>>6&63,128|u&63):(f++,u=65536+((u&1023)<<10|c.charCodeAt(f)&1023),h.push(240|u>>18,128|u>>12&63,128|u>>6&63,128|u&63))}return h};var o={L:1,M:0,Q:3,H:2},a=function(){function c(u){for(var p=0;u!=0;)p+=1,u>>>=1;return p}var h=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],f={w:function(u){for(var p=u<<10;0<=c(p)-c(1335);)p^=1335<<c(p)-c(1335);return(u<<10|p)^21522},A:function(u){for(var p=u<<12;0<=c(p)-c(7973);)p^=7973<<c(p)-c(7973);return u<<12|p},G:function(u){return h[u-1]},F:function(u){switch(u){case 0:return function(p,m){return(p+m)%2==0};case 1:return function(p){return p%2==0};case 2:return function(p,m){return m%3==0};case 3:return function(p,m){return(p+m)%3==0};case 4:return function(p,m){return(Math.floor(p/2)+Math.floor(m/3))%2==0};case 5:return function(p,m){return p*m%2+p*m%3==0};case 6:return function(p,m){return(p*m%2+p*m%3)%2==0};case 7:return function(p,m){return(p*m%3+(p+m)%2)%2==0};default:throw Error("bad maskPattern:"+u)}},C:function(u){for(var p=s([1],0),m=0;m<u;m+=1)p=p.multiply(s([1,n.i(m)],0));return p},f:function(u,p){if(u!=4||1>p||40<p)throw Error("mode: "+u+"; type: "+p);return 10>p?8:16},D:function(u){for(var p=u.h(),m=0,b=0;b<p;b+=1)for(var v=0;v<p;v+=1){for(var $=0,E=u.a(b,v),w=-1;1>=w;w+=1)if(!(0>b+w||p<=b+w))for(var C=-1;1>=C;C+=1)0>v+C||p<=v+C||(w!=0||C!=0)&&E==u.a(b+w,v+C)&&($+=1);5<$&&(m+=3+$-5)}for(b=0;b<p-1;b+=1)for(v=0;v<p-1;v+=1)$=0,u.a(b,v)&&($+=1),u.a(b+1,v)&&($+=1),u.a(b,v+1)&&($+=1),u.a(b+1,v+1)&&($+=1),($==0||$==4)&&(m+=3);for(b=0;b<p;b+=1)for(v=0;v<p-6;v+=1)u.a(b,v)&&!u.a(b,v+1)&&u.a(b,v+2)&&u.a(b,v+3)&&u.a(b,v+4)&&!u.a(b,v+5)&&u.a(b,v+6)&&(m+=40);for(v=0;v<p;v+=1)for(b=0;b<p-6;b+=1)u.a(b,v)&&!u.a(b+1,v)&&u.a(b+2,v)&&u.a(b+3,v)&&u.a(b+4,v)&&!u.a(b+5,v)&&u.a(b+6,v)&&(m+=40);for(v=$=0;v<p;v+=1)for(b=0;b<p;b+=1)u.a(b,v)&&($+=1);return m+=Math.abs(100*$/p/p-50)/5*10}};return f}(),n=function(){for(var c=Array(256),h=Array(256),f=0;8>f;f+=1)c[f]=1<<f;for(f=8;256>f;f+=1)c[f]=c[f-4]^c[f-5]^c[f-6]^c[f-8];for(f=0;255>f;f+=1)h[c[f]]=f;return{g:function(u){if(1>u)throw Error("glog("+u+")");return h[u]},i:function(u){for(;0>u;)u+=255;for(;256<=u;)u-=255;return c[u]}}}(),d=function(){function c(u,p){switch(p){case o.L:return h[4*(u-1)];case o.M:return h[4*(u-1)+1];case o.Q:return h[4*(u-1)+2];case o.H:return h[4*(u-1)+3]}}var h=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],f={I:function(u,p){var m=c(u,p);if(typeof m>"u")throw Error("bad rs block @ typeNumber:"+u+"/errorCorrectLevel:"+p);u=m.length/3,p=[];for(var b=0;b<u;b+=1)for(var v=m[3*b],$=m[3*b+1],E=m[3*b+2],w=0;w<v;w+=1){var C=E,g={};g.o=$,g.j=C,p.push(g)}return p}};return f}();return i}());const bn=QrCreator;var Ft=class extends z{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H"}firstUpdated(){this.generate()}generate(){this.hasUpdated&&bn.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:this.background,size:this.size*2},this.canvas)}render(){var t;return y`
      ...
      ></canvas>
    `}};Ft.styles=[L,mn];r([k("canvas")],Ft.prototype,"canvas",2);r([l()],Ft.prototype,"value",2);r([l()],Ft.prototype,"label",2);r([l({type:Number})],Ft.prototype,"size",2);r([l()],Ft.prototype,"fill",2);r([l()],Ft.prototype,"background",2);r([l({type:Number})],Ft.prototype,"radius",2);r([l({attribute:"error-correction"})],Ft.prototype,"errorCorrection",2);r([x(["background","errorCorrection","fill","radius","size","value"])],Ft.prototype,"generate",1);Ft.define("sl-qr-code");var gn=T`
  :host {
    display: block;
  }
...
`,jt=class extends z{constructor(){super(),this.checked=!1,this.hasFocus=!1,this.size="medium",this.disabled=!1,this.handleBlur=()=>{this.hasFocus=!1,this.emit("sl-blur")},this.handleClick=()=>{this.disabled||(this.checked=!0)},this.handleFocus=()=>{this.hasFocus=!0,this.emit("sl-focus")},this.addEventListener("blur",this.handleBlur),this.addEventListener("click",this.handleClick),this.addEventListener("focus",this.handleFocus)}connectedCallback(){super.connectedCallback(),this.setInitialAttributes()}setInitialAttributes(){this.setAttribute("role","radio"),this.setAttribute("tabindex","-1"),this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleCheckedChange(){this.setAttribute("aria-checked",this.checked?"true":"false"),this.setAttribute("tabindex",this.checked?"0":"-1")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}render(){return y`
    ...
    `}};jt.styles=[L,gn];jt.dependencies={"sl-icon":j};r([I()],jt.prototype,"checked",2);r([I()],jt.prototype,"hasFocus",2);r([l()],jt.prototype,"value",2);r([l({reflect:!0})],jt.prototype,"size",2);r([l({type:Boolean,reflect:!0})],jt.prototype,"disabled",2);r([x("checked")],jt.prototype,"handleCheckedChange",1);r([x("disabled",{waitUntilFirstUpdate:!0})],jt.prototype,"handleDisabledChange",1);jt.define("sl-radio");var vn=T`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,Ot=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.isInitialized=!1,this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined("sl-select").then(()=>{const t=this.closest("sl-select");t&&t.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){const t=this.childNodes;let e="";return[...t].forEach(i=>{i.nodeType===Node.ELEMENT_NODE&&(i.hasAttribute("slot")||(e+=i.textContent)),i.nodeType===Node.TEXT_NODE&&(e+=i.textContent)}),e.trim()}render(){return y`
    ...
    `}};Ot.styles=[L,vn];Ot.dependencies={"sl-icon":j};r([k(".option__label")],Ot.prototype,"defaultSlot",2);r([I()],Ot.prototype,"current",2);r([I()],Ot.prototype,"selected",2);r([I()],Ot.prototype,"hasHover",2);r([l({reflect:!0})],Ot.prototype,"value",2);r([l({type:Boolean,reflect:!0})],Ot.prototype,"disabled",2);r([x("disabled")],Ot.prototype,"handleDisabledChange",1);r([x("selected")],Ot.prototype,"handleSelectedChange",1);r([x("value")],Ot.prototype,"handleValueChange",1);Ot.define("sl-option");W.define("sl-popup");var yn=T`
  :host {
    --height: 1rem;
    --track-color: var(--sl-color-neutral-200);
    --indicator-color: var(--sl-color-primary-600);
...
`,di=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return y`
    ...
    `}};di.styles=[L,yn];r([l({type:Number,reflect:!0})],di.prototype,"value",2);r([l({type:Boolean,reflect:!0})],di.prototype,"indeterminate",2);r([l()],di.prototype,"label",2);di.define("sl-progress-bar");var _n=T`
  :host {
    display: block;
  }
...
`,Uo=class extends z{render(){return y` <slot part="base" class="menu-label"></slot> `}};Uo.styles=[L,_n];Uo.define("sl-menu-label");var wn=T`
  :host {
    display: contents;
  }
`,Kt=class extends z{constructor(){super(...arguments),this.attrOldValue=!1,this.charData=!1,this.charDataOldValue=!1,this.childList=!1,this.disabled=!1,this.handleMutation=t=>{this.emit("sl-mutation",{detail:{mutationList:t}})}}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(this.handleMutation),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}startObserver(){const t=typeof this.attr=="string"&&this.attr.length>0,e=t&&this.attr!=="*"?this.attr.split(" "):void 0;try{this.mutationObserver.observe(this,{subtree:!0,childList:this.childList,attributes:t,attributeFilter:e,attributeOldValue:this.attrOldValue,characterData:this.charData,characterDataOldValue:this.charDataOldValue})}catch{}}stopObserver(){this.mutationObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}handleChange(){this.stopObserver(),this.startObserver()}render(){return y` <slot></slot> `}};Kt.styles=[L,wn];r([l({reflect:!0})],Kt.prototype,"attr",2);r([l({attribute:"attr-old-value",type:Boolean,reflect:!0})],Kt.prototype,"attrOldValue",2);r([l({attribute:"char-data",type:Boolean,reflect:!0})],Kt.prototype,"charData",2);r([l({attribute:"char-data-old-value",type:Boolean,reflect:!0})],Kt.prototype,"charDataOldValue",2);r([l({attribute:"child-list",type:Boolean,reflect:!0})],Kt.prototype,"childList",2);r([l({type:Boolean,reflect:!0})],Kt.prototype,"disabled",2);r([x("disabled")],Kt.prototype,"handleDisabledChange",1);r([x("attr",{waitUntilFirstUpdate:!0}),x("attr-old-value",{waitUntilFirstUpdate:!0}),x("char-data",{waitUntilFirstUpdate:!0}),x("char-data-old-value",{waitUntilFirstUpdate:!0}),x("childList",{waitUntilFirstUpdate:!0})],Kt.prototype,"handleChange",1);Kt.define("sl-mutation-observer");var xn=T`
  :host {
    display: block;
  }
...
`,As=class extends z{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){const e=["menuitem","menuitemcheckbox"],i=t.composedPath(),s=i.find(d=>{var c;return e.includes(((c=d==null?void 0:d.getAttribute)==null?void 0:c.call(d,"role"))||"")});if(!s||i.find(d=>{var c;return((c=d==null?void 0:d.getAttribute)==null?void 0:c.call(d,"role"))==="menu"})!==this)return;const n=s;n.type==="checkbox"&&(n.checked=!n.checked),this.emit("sl-select",{detail:{item:n}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){const e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e==null||e.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){const e=this.getAllItems(),i=this.getCurrentItem();let s=i?e.indexOf(i):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?s++:t.key==="ArrowUp"?s--:t.key==="Home"?s=0:t.key==="End"&&(s=e.length-1),s<0&&(s=e.length-1),s>e.length-1&&(s=0),this.setCurrentItem(e[s]),e[s].focus())}}handleMouseDown(t){const e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){const t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===t?"0":"-1")})}render(){return y`
      <slot
        ...
        @mousedown=${this.handleMouseDown}
      ></slot>
    `}};As.styles=[L,kn];r([k("slot")],As.prototype,"defaultSlot",2);As.define("sl-menu");var Cn=T`
  :host {
    --submenu-offset: -2px;
 ...
 */const En=()=>new Tn;class Tn{}const Gi=new WeakMap,In=si(class extends An{render(t){return K}update(t,[e]){var s;const i=e!==this.G;return i&&this.G!==void 0&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=(s=t.options)==null?void 0:s.host,this.rt(this.ct=t.element)),K}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let i=Gi.get(e);i===void 0&&(i=new WeakMap,Gi.set(e,i)),i.get(this.G)!==void 0&&this.G.call(this.ht,void 0),i.set(this.G,t),t!==void 0&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){var t,e;return typeof this.G=="function"?(t=Gi.get(this.ht??globalThis))==null?void 0:t.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var On=class{constructor(t,e){this.popupRef=En(),this.enableSubmenuTimer=-1,this.isConnected=!1,this.isPopupConnected=!1,this.skidding=0,this.submenuOpenDelay=100,this.handleMouseMove=i=>{this.host.style.setProperty("--safe-triangle-cursor-x",`${i.clientX}px`),this.host.style.setProperty("--safe-triangle-cursor-y",`${i.clientY}px`)},this.handleMouseOver=()=>{this.hasSlotController.test("submenu")&&this.enableSubmenu()},this.handleKeyDown=i=>{switch(i.key){case"Escape":case"Tab":this.disableSubmenu();break;case"ArrowLeft":i.target!==this.host&&(i.preventDefault(),i.stopPropagation(),this.host.focus(),this.disableSubmenu());break;case"ArrowRight":case"Enter":case" ":this.handleSubmenuEntry(i);break}},this.handleClick=i=>{var s;i.target===this.host?(i.preventDefault(),i.stopPropagation()):i.target instanceof Element&&(i.target.tagName==="sl-menu-item"||(s=i.target.role)!=null&&s.startsWith("menuitem"))&&this.disableSubmenu()},this.handleFocusOut=i=>{i.relatedTarget&&i.relatedTarget instanceof Element&&this.host.contains(i.relatedTarget)||this.disableSubmenu()},this.handlePopupMouseover=i=>{i.stopPropagation()},this.handlePopupReposition=()=>{const i=this.host.renderRoot.querySelector("slot[name='submenu']"),s=i==null?void 0:i.assignedElements({flatten:!0}).filter(h=>h.localName==="sl-menu")[0],o=getComputedStyle(this.host).direction==="rtl";if(!s)return;const{left:a,top:n,width:d,height:c}=s.getBoundingClientRect();this.host.style.setProperty("--safe-triangle-submenu-start-x",`${o?a+d:a}px`),this.host.style.setProperty("--safe-triangle-submenu-start-y",`${n}px`),this.host.style.setProperty("--safe-triangle-submenu-end-x",`${o?a+d:a}px`),this.host.style.setProperty("--safe-triangle-submenu-end-y",`${n+c}px`)},(this.host=t).addController(this),this.hasSlotController=e}hostConnected(){this.hasSlotController.test("submenu")&&!this.host.disabled&&this.addListeners()}hostDisconnected(){this.removeListeners()}hostUpdated(){this.hasSlotController.test("submenu")&&!this.host.disabled?(this.addListeners(),this.updateSkidding()):this.removeListeners()}addListeners(){this.isConnected||(this.host.addEventListener("mousemove",this.handleMouseMove),this.host.addEventListener("mouseover",this.handleMouseOver),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("click",this.handleClick),this.host.addEventListener("focusout",this.handleFocusOut),this.isConnected=!0),this.isPopupConnected||this.popupRef.value&&(this.popupRef.value.addEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.addEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!0)}removeListeners(){this.isConnected&&(this.host.removeEventListener("mousemove",this.handleMouseMove),this.host.removeEventListener("mouseover",this.handleMouseOver),this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("click",this.handleClick),this.host.removeEventListener("focusout",this.handleFocusOut),this.isConnected=!1),this.isPopupConnected&&this.popupRef.value&&(this.popupRef.value.removeEventListener("mouseover",this.handlePopupMouseover),this.popupRef.value.removeEventListener("sl-reposition",this.handlePopupReposition),this.isPopupConnected=!1)}handleSubmenuEntry(t){const e=this.host.renderRoot.querySelector("slot[name='submenu']");if(!e){console.error("Cannot activate a submenu if no corresponding menuitem can be found.",this);return}let i=null;for(const s of e.assignedElements())if(i=s.querySelectorAll("sl-menu-item, [role^='menuitem']"),i.length!==0)break;if(!(!i||i.length===0)){i[0].setAttribute("tabindex","0");for(let s=1;s!==i.length;++s)i[s].setAttribute("tabindex","-1");this.popupRef.value&&(t.preventDefault(),t.stopPropagation(),this.popupRef.value.active?i[0]instanceof HTMLElement&&i[0].focus():(this.enableSubmenu(!1),this.host.updateComplete.then(()=>{i[0]instanceof HTMLElement&&i[0].focus()}),this.host.requestUpdate()))}}setSubmenuState(t){this.popupRef.value&&this.popupRef.value.active!==t&&(this.popupRef.value.active=t,this.host.requestUpdate())}enableSubmenu(t=!0){t?(window.clearTimeout(this.enableSubmenuTimer),this.enableSubmenuTimer=window.setTimeout(()=>{this.setSubmenuState(!0)},this.submenuOpenDelay)):this.setSubmenuState(!0)}disableSubmenu(){window.clearTimeout(this.enableSubmenuTimer),this.setSubmenuState(!1)}updateSkidding(){var t;if(!((t=this.host.parentElement)!=null&&t.computedStyleMap))return;const e=this.host.parentElement.computedStyleMap(),s=["padding-top","border-top-width","margin-top"].reduce((o,a)=>{var n;const d=(n=e.get(a))!=null?n:new CSSUnitValue(0,"px"),h=(d instanceof CSSUnitValue?d:new CSSUnitValue(0,"px")).to("px");return o-h.value},0);this.skidding=s}isExpanded(){return this.popupRef.value?this.popupRef.value.active:!1}renderSubmenu(){const t=getComputedStyle(this.host).direction==="rtl";return this.isConnected?y`
    ...
    `}};zt.styles=[L,Cn];zt.dependencies={"sl-icon":j,"sl-popup":W,"sl-spinner":ri};r([k("slot:not([name])")],zt.prototype,"defaultSlot",2);r([k(".menu-item")],zt.prototype,"menuItem",2);r([l()],zt.prototype,"type",2);r([l({type:Boolean,reflect:!0})],zt.prototype,"checked",2);r([l()],zt.prototype,"value",2);r([l({type:Boolean,reflect:!0})],zt.prototype,"loading",2);r([l({type:Boolean,reflect:!0})],zt.prototype,"disabled",2);r([x("checked")],zt.prototype,"handleCheckedChange",1);r([x("disabled")],zt.prototype,"handleDisabledChange",1);r([x("type")],zt.prototype,"handleTypeChange",1);zt.define("sl-menu-item");var Ln=T`
  :host {
    --divider-width: 2px;
    --handle-size: 2.5rem;
...
`,_e=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.position=50}handleDrag(t){const{width:e}=this.base.getBoundingClientRect(),i=this.localize.dir()==="rtl";t.preventDefault(),Xe(this.base,{onMove:s=>{this.position=parseFloat(et(s/e*100,0,100).toFixed(2)),i&&(this.position=100-this.position)},initialEvent:t})}handleKeyDown(t){const e=this.localize.dir()==="ltr",i=this.localize.dir()==="rtl";if(["ArrowLeft","ArrowRight","Home","End"].includes(t.key)){const s=t.shiftKey?10:1;let o=this.position;t.preventDefault(),(e&&t.key==="ArrowLeft"||i&&t.key==="ArrowRight")&&(o-=s),(e&&t.key==="ArrowRight"||i&&t.key==="ArrowLeft")&&(o+=s),t.key==="Home"&&(o=0),t.key==="End"&&(o=100),o=et(o,0,100),this.position=o}}handlePositionChange(){this.emit("sl-change")}render(){const t=this.localize.dir()==="rtl";return y`
    ...
    `}};_e.styles=[L,Ln];_e.scopedElement={"sl-icon":j};r([k(".image-comparer")],_e.prototype,"base",2);r([k(".image-comparer__handle")],_e.prototype,"handle",2);r([l({type:Number,reflect:!0})],_e.prototype,"position",2);r([x("position",{waitUntilFirstUpdate:!0})],_e.prototype,"handlePositionChange",1);_e.define("sl-image-comparer");var Dn=T`
  :host {
    display: block;
  }
`,Qi=new Map;function Pn(t,e="cors"){const i=Qi.get(t);if(i!==void 0)return Promise.resolve(i);const s=fetch(t,{mode:e}).then(async o=>{const a={ok:o.ok,status:o.status,html:await o.text()};return Qi.set(t,a),a});return Qi.set(t,s),s}var Oe=class extends z{constructor(){super(...arguments),this.mode="cors",this.allowScripts=!1}executeScript(t){const e=document.createElement("script");[...t.attributes].forEach(i=>e.setAttribute(i.name,i.value)),e.textContent=t.textContent,t.parentNode.replaceChild(e,t)}async handleSrcChange(){try{const t=this.src,e=await Pn(t,this.mode);if(t!==this.src)return;if(!e.ok){this.emit("sl-error",{detail:{status:e.status}});return}this.innerHTML=e.html,this.allowScripts&&[...this.querySelectorAll("script")].forEach(i=>this.executeScript(i)),this.emit("sl-load")}catch{this.emit("sl-error",{detail:{status:-1}})}}render(){return y`<slot></slot>`}};Oe.styles=[L,Dn];r([l()],Oe.prototype,"src",2);r([l()],Oe.prototype,"mode",2);r([l({attribute:"allow-scripts",type:Boolean})],Oe.prototype,"allowScripts",2);r([x("src")],Oe.prototype,"handleSrcChange",1);Oe.define("sl-include");var Mn=j;j.define("sl-icon");ot.define("sl-icon-button");var Fi=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.value=0,this.unit="byte",this.display="short"}render(){if(isNaN(this.value))return"";const t=["","kilo","mega","giga","tera"],e=["","kilo","mega","giga","tera","peta"],i=this.unit==="bit"?t:e,s=Math.max(0,Math.min(Math.floor(Math.log10(this.value)/3),i.length-1)),o=i[s]+this.unit,a=parseFloat((this.value/Math.pow(1e3,s)).toPrecision(3));return this.localize.number(a,{style:"unit",unit:o,unitDisplay:this.display})}};r([l({type:Number})],Fi.prototype,"value",2);r([l()],Fi.prototype,"unit",2);r([l()],Fi.prototype,"display",2);Fi.define("sl-format-bytes");var At=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.date=new Date,this.hourFormat="auto"}render(){const t=new Date(this.date),e=this.hourFormat==="auto"?void 0:this.hourFormat==="12";if(!isNaN(t.getMilliseconds()))return y`
      <time datetime=${t.toISOString()}>
        ${this.localize.date(t,{weekday:this.weekday,era:this.era,year:this.year,month:this.month,day:this.day,hour:this.hour,minute:this.minute,second:this.second,timeZoneName:this.timeZoneName,timeZone:this.timeZone,hour12:e})}
      </time>
    `}};r([l()],At.prototype,"date",2);r([l()],At.prototype,"weekday",2);r([l()],At.prototype,"era",2);r([l()],At.prototype,"year",2);r([l()],At.prototype,"month",2);r([l()],At.prototype,"day",2);r([l()],At.prototype,"hour",2);r([l()],At.prototype,"minute",2);r([l()],At.prototype,"second",2);r([l({attribute:"time-zone-name"})],At.prototype,"timeZoneName",2);r([l({attribute:"time-zone"})],At.prototype,"timeZone",2);r([l({attribute:"hour-format"})],At.prototype,"hourFormat",2);At.define("sl-format-date");var Vt=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.value=0,this.type="decimal",this.noGrouping=!1,this.currency="USD",this.currencyDisplay="symbol"}render(){return isNaN(this.value)?"":this.localize.number(this.value,{style:this.type,currency:this.currency,currencyDisplay:this.currencyDisplay,useGrouping:!this.noGrouping,minimumIntegerDigits:this.minimumIntegerDigits,minimumFractionDigits:this.minimumFractionDigits,maximumFractionDigits:this.maximumFractionDigits,minimumSignificantDigits:this.minimumSignificantDigits,maximumSignificantDigits:this.maximumSignificantDigits})}};r([l({type:Number})],Vt.prototype,"value",2);r([l()],Vt.prototype,"type",2);r([l({attribute:"no-grouping",type:Boolean})],Vt.prototype,"noGrouping",2);r([l()],Vt.prototype,"currency",2);r([l({attribute:"currency-display"})],Vt.prototype,"currencyDisplay",2);r([l({attribute:"minimum-integer-digits",type:Number})],Vt.prototype,"minimumIntegerDigits",2);r([l({attribute:"minimum-fraction-digits",type:Number})],Vt.prototype,"minimumFractionDigits",2);r([l({attribute:"maximum-fraction-digits",type:Number})],Vt.prototype,"maximumFractionDigits",2);r([l({attribute:"minimum-significant-digits",type:Number})],Vt.prototype,"minimumSignificantDigits",2);r([l({attribute:"maximum-significant-digits",type:Number})],Vt.prototype,"maximumSignificantDigits",2);Vt.define("sl-format-number");var Rn=T`
  :host {
...
`,Vi=class extends z{constructor(){super(...arguments),this.vertical=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","separator")}handleVerticalChange(){this.setAttribute("aria-orientation",this.vertical?"vertical":"horizontal")}};Vi.styles=[L,Rn];r([l({type:Boolean,reflect:!0})],Vi.prototype,"vertical",2);r([x("vertical")],Vi.prototype,"handleVerticalChange",1);Vi.define("sl-divider");var Fn=T`
  :host {
    --size: 25rem;
...
`;function*Es(t=document.activeElement){t!=null&&(yield t,"shadowRoot"in t&&t.shadowRoot&&t.shadowRoot.mode!=="closed"&&(yield*br(Es(t.shadowRoot.activeElement))))}function qo(){return[...Es()].pop()}var io=new WeakMap;function jo(t){let e=io.get(t);return e||(e=window.getComputedStyle(t,null),io.set(t,e)),e}function Vn(t){if(typeof t.checkVisibility=="function")return t.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const e=jo(t);return e.visibility!=="hidden"&&e.display!=="none"}function Bn(t){const e=jo(t),{overflowY:i,overflowX:s}=e;return i==="scroll"||s==="scroll"?!0:i!=="auto"||s!=="auto"?!1:t.scrollHeight>t.clientHeight&&i==="auto"||t.scrollWidth>t.clientWidth&&s==="auto"}function Hn(t){const e=t.tagName.toLowerCase(),i=Number(t.getAttribute("tabindex"));if(t.hasAttribute("tabindex")&&(isNaN(i)||i<=-1)||t.hasAttribute("disabled")||t.closest("[inert]"))return!1;if(e==="input"&&t.getAttribute("type")==="radio"){const a=t.getRootNode(),n=`input[type='radio'][name="${t.getAttribute("name")}"]`,d=a.querySelector(`${n}:checked`);return d?d===t:a.querySelector(n)===t}return Vn(t)?(e==="audio"||e==="video")&&t.hasAttribute("controls")||t.hasAttribute("tabindex")||t.hasAttribute("contenteditable")&&t.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(e)?!0:Bn(t):!1}function Nn(t){var e,i;const s=hs(t),o=(e=s[0])!=null?e:null,a=(i=s[s.length-1])!=null?i:null;return{start:o,end:a}}function Un(t,e){var i;return((i=t.getRootNode({composed:!0}))==null?void 0:i.host)!==e}function hs(t){const e=new WeakMap,i=[];function s(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||e.has(o))return;e.set(o,!0),!i.includes(o)&&Hn(o)&&i.push(o),o instanceof HTMLSlotElement&&Un(o,t)&&o.assignedElements({flatten:!0}).forEach(a=>{s(a)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&s(o.shadowRoot)}for(const a of o.children)s(a)}return s(t),i.sort((o,a)=>{const n=Number(o.getAttribute("tabindex"))||0;return(Number(a.getAttribute("tabindex"))||0)-n})}var Be=[],Ko=class{constructor(t){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=e=>{var i;if(e.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=qo();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;e.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const o=hs(this.element);let a=o.findIndex(d=>d===s);this.previousFocus=this.currentFocus;const n=this.tabDirection==="forward"?1:-1;for(;;){a+n>=o.length?a=0:a+n<0?a=o.length-1:a+=n,this.previousFocus=this.currentFocus;const d=o[a];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||d&&this.possiblyHasTabbableChildren(d))return;e.preventDefault(),this.currentFocus=d,(i=this.currentFocus)==null||i.focus({preventScroll:!1});const c=[...Es()];if(c.includes(this.currentFocus)||!c.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=t,this.elementsWithTabbableControls=["iframe"]}activate(){Be.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Be=Be.filter(t=>t!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Be[Be.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const t=hs(this.element);if(!this.element.matches(":focus-within")){const e=t[0],i=t[t.length-1],s=this.tabDirection==="forward"?e:i;typeof(s==null?void 0:s.focus)=="function"&&(this.currentFocus=s,s.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(t){return this.elementsWithTabbableControls.includes(t.tagName.toLowerCase())||t.hasAttribute("controls")}},Ts=t=>{var e;const{activeElement:i}=document;i&&t.contains(i)&&((e=document.activeElement)==null||e.blur())};function so(t){return t.charAt(0).toUpperCase()+t.slice(1)}var Et=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"footer"),this.localize=new H(this),this.modal=new Ko(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=t=>{this.contained||t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopImmediatePropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),je(this)))}disconnectedCallback(){super.disconnectedCallback(),Ke(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const i=X(this,"drawer.denyClose",{dir:this.localize.dir()});Z(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;document.removeEventListener("keydown",this.handleDocumentKeyDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),je(this));const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([it(this.drawer),it(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=X(this,`drawer.show${so(this.placement)}`,{dir:this.localize.dir()}),i=X(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([Z(this.panel,e.keyframes,e.options),Z(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{Ts(this),this.emit("sl-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Ke(this)),await Promise.all([it(this.drawer),it(this.overlay)]);const t=X(this,`drawer.hide${so(this.placement)}`,{dir:this.localize.dir()}),e=X(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([Z(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),Z(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),je(this)),this.open&&this.contained&&(this.modal.deactivate(),Ke(this))}async show(){if(!this.open)return this.open=!0,gt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,gt(this,"sl-after-hide")}render(){return y`
      <div
        part="base"
...
`,ut=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=t=>{this.open&&t.key==="Escape"&&(t.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=t=>{var e;if(t.key==="Escape"&&this.open&&!this.closeWatcher){t.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(t.key==="Tab"){if(this.open&&((e=document.activeElement)==null?void 0:e.tagName.toLowerCase())==="sl-menu-item"){t.preventDefault(),this.hide(),this.focusOnTrigger();return}const i=(s,o)=>{if(!s)return null;const a=s.closest(o);if(a)return a;const n=s.getRootNode();return n instanceof ShadowRoot?i(n.host,o):null};setTimeout(()=>{var s;const o=((s=this.containingElement)==null?void 0:s.getRootNode())instanceof ShadowRoot?qo():document.activeElement;(!this.containingElement||i(o,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=t=>{const e=t.composedPath();this.containingElement&&!e.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=t=>{const e=t.target;!this.stayOpenOnSelect&&e.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const t=this.trigger.assignedElements({flatten:!0})[0];typeof(t==null?void 0:t.focus)=="function"&&t.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(t=>t.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(t){if([" ","Enter"].includes(t.key)){t.preventDefault(),this.handleTriggerClick();return}const e=this.getMenu();if(e){const i=e.getAllItems(),s=i[0],o=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(t.key)&&(t.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(t.key==="ArrowDown"||t.key==="Home")&&(e.setCurrentItem(s),s.focus()),(t.key==="ArrowUp"||t.key==="End")&&(e.setCurrentItem(o),o.focus())}))}}handleTriggerKeyUp(t){t.key===" "&&t.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const e=this.trigger.assignedElements({flatten:!0}).find(s=>Nn(s).start);let i;if(e){switch(e.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=e.button;break;default:i=e}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,gt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,gt(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var t;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var t;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(t=this.closeWatcher)==null||t.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await it(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:t,options:e}=X(this,"dropdown.show",{dir:this.localize.dir()});await Z(this.popup.popup,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await it(this);const{keyframes:t,options:e}=X(this,"dropdown.hide",{dir:this.localize.dir()});await Z(this.popup.popup,t,e),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return y`
      <sl-popup
        part="base"
...
`,Xt=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"footer"),this.localize=new H(this),this.modal=new Ko(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.modal.isActive()&&this.open&&(t.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),je(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),Ke(this),this.removeOpenListeners()}requestClose(t){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:t}}).defaultPrevented){const i=X(this,"dialog.denyClose",{dir:this.localize.dir()});Z(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var t;"CloseWatcher"in window?((t=this.closeWatcher)==null||t.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var t;(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),je(this);const t=this.querySelector("[autofocus]");t&&t.removeAttribute("autofocus"),await Promise.all([it(this.dialog),it(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(t?t.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),t&&t.setAttribute("autofocus","")});const e=X(this,"dialog.show",{dir:this.localize.dir()}),i=X(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([Z(this.panel,e.keyframes,e.options),Z(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{Ts(this),this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([it(this.dialog),it(this.overlay)]);const t=X(this,"dialog.hide",{dir:this.localize.dir()}),e=X(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([Z(this.overlay,e.keyframes,e.options).then(()=>{this.overlay.hidden=!0}),Z(this.panel,t.keyframes,t.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,Ke(this);const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,gt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,gt(this,"sl-after-hide")}render(){return y`
      <div
        part="base"
    ...
    `}};Xt.styles=[L,Kn];Xt.dependencies={"sl-icon-button":ot};r([k(".dialog")],Xt.prototype,"dialog",2);r([k(".dialog__panel")],Xt.prototype,"panel",2);r([k(".dialog__overlay")],Xt.prototype,"overlay",2);r([l({type:Boolean,reflect:!0})],Xt.prototype,"open",2);r([l({reflect:!0})],Xt.prototype,"label",2);r([l({attribute:"no-header",type:Boolean,reflect:!0})],Xt.prototype,"noHeader",2);r([x("open",{waitUntilFirstUpdate:!0})],Xt.prototype,"handleOpenChange",1);U("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});U("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});U("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});U("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});U("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Xt.define("sl-dialog");st.define("sl-checkbox");var Xn=T`
  :host {
    --grid-width: 280px;
    --grid-height: 200px;
...
`,q=class extends z{constructor(){super(...arguments),this.formControlController=new Zt(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new vt(this,"[default]","prefix","suffix"),this.localize=new H(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Oi}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?Ti`a`:Ti`button`;return qe`
    ...
    `}};B.styles=[L,Xn];B.dependencies={"sl-button-group":ye,"sl-button":q,"sl-dropdown":ut,"sl-icon":j,"sl-input":R,"sl-visually-hidden":Ss};r([k('[part~="base"]')],B.prototype,"base",2);r([k('[part~="input"]')],B.prototype,"input",2);r([k(".color-dropdown")],B.prototype,"dropdown",2);r([k('[part~="preview"]')],B.prototype,"previewButton",2);r([k('[part~="trigger"]')],B.prototype,"trigger",2);r([I()],B.prototype,"hasFocus",2);r([I()],B.prototype,"isDraggingGridHandle",2);r([I()],B.prototype,"isEmpty",2);r([I()],B.prototype,"inputValue",2);r([I()],B.prototype,"hue",2);r([I()],B.prototype,"saturation",2);r([I()],B.prototype,"brightness",2);r([I()],B.prototype,"alpha",2);r([l()],B.prototype,"value",2);r([ze()],B.prototype,"defaultValue",2);r([l()],B.prototype,"label",2);r([l()],B.prototype,"format",2);r([l({type:Boolean,reflect:!0})],B.prototype,"inline",2);r([l({reflect:!0})],B.prototype,"size",2);r([l({attribute:"no-format-toggle",type:Boolean})],B.prototype,"noFormatToggle",2);r([l()],B.prototype,"name",2);r([l({type:Boolean,reflect:!0})],B.prototype,"disabled",2);r([l({type:Boolean})],B.prototype,"hoist",2);r([l({type:Boolean})],B.prototype,"opacity",2);r([l({type:Boolean})],B.prototype,"uppercase",2);r([l()],B.prototype,"swatches",2);r([l({reflect:!0})],B.prototype,"form",2);r([l({type:Boolean,reflect:!0})],B.prototype,"required",2);r([ii({passive:!1})],B.prototype,"handleTouchMove",1);r([x("format",{waitUntilFirstUpdate:!0})],B.prototype,"handleFormatChange",1);r([x("opacity",{waitUntilFirstUpdate:!0})],B.prototype,"handleOpacityChange",1);r([x("value")],B.prototype,"handleValueChange",1);B.define("sl-color-picker");var ll=T`
  :host {
    --border-color: var(--sl-color-neutral-200);
    --border-radius: var(--sl-border-radius-medium);
    --border-width: 1px;
...
`,Go=class extends z{connectedCallback(){super.connectedCallback()}render(){return y` <slot></slot> `}};Go.styles=[L,fl];Go.define("sl-carousel-item");var ml=T`
  :host {
    display: inline-flex;
  }
...
`,ae=class extends z{constructor(){super(...arguments),this.hasSlotController=new vt(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){const t=this.defaultSlot.assignedElements({flatten:!0}).filter(e=>e.tagName.toLowerCase()==="sl-dropdown").length>0;if(this.href){this.renderType="link";return}if(t){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return y`
    ...
    `}};ae.styles=[L,ml];r([k("slot:not([name])")],ae.prototype,"defaultSlot",2);r([I()],ae.prototype,"renderType",2);r([l()],ae.prototype,"href",2);r([l()],ae.prototype,"target",2);r([l()],ae.prototype,"rel",2);r([x("href",{waitUntilFirstUpdate:!0})],ae.prototype,"hrefChanged",1);ae.define("sl-breadcrumb-item");ye.define("sl-button-group");var bl=T`
  :host {
    display: inline-block;
...
`,Yt=class extends z{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){const t=y`
    ...
    `}};Yt.styles=[L,bl];Yt.dependencies={"sl-icon":j};r([I()],Yt.prototype,"hasError",2);r([l()],Yt.prototype,"image",2);r([l()],Yt.prototype,"label",2);r([l()],Yt.prototype,"initials",2);r([l()],Yt.prototype,"loading",2);r([l({reflect:!0})],Yt.prototype,"shape",2);r([x("image")],Yt.prototype,"handleImageChange",1);Yt.define("sl-avatar");var gl=T`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
  }
`,Le=class extends z{constructor(){super(...arguments),this.localize=new H(this),this.separatorDir=this.localize.dir(),this.label=""}getSeparator(){const e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}handleSlotChange(){const t=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()==="sl-breadcrumb-item");t.forEach((e,i)=>{const s=e.querySelector('[slot="separator"]');s===null?e.append(this.getSeparator()):s.hasAttribute("data-default")&&s.replaceWith(this.getSeparator()),i===t.length-1?e.setAttribute("aria-current","page"):e.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),y`
    ...
    `}};Le.styles=[L,gl];Le.dependencies={"sl-icon":j};r([k("slot")],Le.prototype,"defaultSlot",2);r([k('slot[name="separator"]')],Le.prototype,"separatorSlot",2);r([l()],Le.prototype,"label",2);Le.define("sl-breadcrumb");q.define("sl-button");var vl=T`
  :host {
...
`,Ht=class extends z{constructor(){super(...arguments),this.isLoaded=!1}handleClick(){this.play=!this.play}handleLoad(){const t=document.createElement("canvas"),{width:e,height:i}=this.animatedImage;t.width=e,t.height=i,t.getContext("2d").drawImage(this.animatedImage,0,0,e,i),this.frozenFrame=t.toDataURL("image/gif"),this.isLoaded||(this.emit("sl-load"),this.isLoaded=!0)}handleError(){this.emit("sl-error")}handlePlayChange(){this.play&&(this.animatedImage.src="",this.animatedImage.src=this.src)}handleSrcChange(){this.isLoaded=!1}render(){return y`
...
`,hi=class extends z{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return y`
    ...
    `}};hi.styles=[L,yl];r([l({reflect:!0})],hi.prototype,"variant",2);r([l({type:Boolean,reflect:!0})],hi.prototype,"pill",2);r([l({type:Boolean,reflect:!0})],hi.prototype,"pulse",2);hi.define("sl-badge");var _l=T`
  :host {
    display: contents;
