...
### Accessibility
- When a slideout is triggered from a disclosure menu, focus is now set to the menu button when the slideout is closed. ([#16587](https://github.com/craftcms/cms/pull/16587))
