...
return [
    ...
    'Allows deleting {type} on the current site, provided the user has access to it.' => 'Allows deleting {type} on the current site, provided the user has access to it.',
    'Allows deleting other users’ {type} for all sites.' => 'Allows deleting other users’ {type} for all sites.',
    'Allows deleting other users’ {type} on the current site, provided the user has access to it.' => 'Allows deleting other users’ {type} on the current site, provided the user has access to it.',
