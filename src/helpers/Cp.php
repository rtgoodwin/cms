        ...
        return ArrayHelper::merge(
            ...
            [
                ...
                'data' => array_filter([
                    ...
                    'deletable-for-site' => $editable && self::contextIsAdministrative($config['context']) && ElementHelper::isElementMultisite($element) && $elementsService->canDeleteForSite($element, $user),
                ]),
            ],
        );
    }
